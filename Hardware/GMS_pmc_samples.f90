...
module pmc_samples
 ...
 !==================================================================================85
    ...
    ! Module build date
    character(*),        parameter :: PMC_SAMPLES_BUILD_DATE    = __DATE__ 

    character(*),        parameter :: PMC_SAMPLES_BUILD_TIME    = __TIME__
    ! Module author info
  ...
  contains
    ...
    subroutine init_1D_no_bounds(pmc,nx,val)
      ...
      use mod_print_error, only : print_backtrace_and_exit
      ...
      allocate( pmc.tsc(nx),     &
                ...
                ERRMSG=msg)
      if(err/=0) then
         call print_backtrace_and_exit(name//msg)
      end if
      pmc.is_alloc=.true.
      if(present(val)) then
         pmc.tsc  = val
    ...
    subroutine init_3D_bounds(pmc,nx_lo,nx_hi, &
      ...
      allocate( pmc.tsc(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),     &
                pmc.r309(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),    &
                pmc.r30a(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),    &
                pmc.r30b(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),    &
                pmc.c0(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),      &
                pmc.c1(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),      &
                pmc.c2(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),      &
                pmc.c3(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),      &
                pmc.c4(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),      &
                pmc.c5(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),      &
                pmc.c6(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),      &
                pmc.c7(nx_lo:nx_hi,ny_lo:ny_hi,nz_lo:nz_hi),      &
                STAT=err,        &
                ERRMSG=msg)
      if(err/=0) then
          call print_backtrace_and_exit(name//msg)
