...
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: initIA32_PMC0
     ...
     subroutine AccessIA32_PMC0(reg,op,command,fname,ier)
       !DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PMC0
           ...
           integer(kind=int2), automatic :: stat
           ! Exec code ....
           include 'GMS_imsrt_acpmc_body.inc'
...
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: initIA32_PMC1
     ...
     subroutine AccessIA32_PMC1(reg,op,command,fname,ier)
...
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: initIA32_PMC2
     ...
     subroutine AccessIA32_PMC2(reg,op,command,fname,ier)
     ...
     subroutine ReadIA32_PMC2(msr,iounit,fname,stat,err,ermsg)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PMC2
           type(MSR_IA32_PMC2),                   intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           ...
           integer(kind=int4), automatic :: i,ioerr
           include 'GMS_imsrt_ra_body.inc'
     end subroutine ReadIA32_PMC2

     subroutine initIA32_PMC3(msr)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: initIA32_PMC3
           type(MSR_IA32_PMC3),      intent(inout) :: msr
           ! EXec code .....
           msr.msr_read = zero_val
     end subroutine initIA32_PMC3
...
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PMC3
     ...
     subroutine ReadIA32_PMC3(msr,iounit,fname,status,err,ermsg)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PMC3
           type(MSR_IA32_PMC3),                   intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           ...
           integer(kind=int4), automatic :: i,ioerr
           include 'GMS_imsrt_ra_body.inc'
     end subroutine ReadIA32_PMC3

     subroutine initIA32_PMC4(msr)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: initIA32_PMC4
           type(MSR_IA32_PMC4),       intent(inout) :: msr
           ! Exec code ...
           msr.msr_read = zero_val
     end subroutine initIA32_PMC4
...
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PMC4
     ...
     subroutine ReadIA32_PMC4(msr,iounit,fname,status,err,ermsg)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PMC4
           type(MSR_IA32_PMC4),                   intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           ...
           integer(kind=int4), automatic :: i,ioerr
           include 'GMS_imsrt_ra_body.inc'
     end subroutine ReadIA32_PMC4

     subroutine initIA32_PMC5(msr)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: initIA32_PMC5
           type(MSR_IA32_PMC5),       intent(inout)  :: msr
           ! Exec code ....
           msr.msr_read = zero_val
     end subroutine initIA32_PMC5
...
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PMC5
      ...
      subroutine ReadIA32_PMC5(msr,iounit,fname,status,err,ermsg)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PMC5
           type(MSR_IA32_PMC5),                   intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           ...
           integer(kind=int4), automatic :: i,ioerr
           include 'GMS_imsrt_ra_body.inc'
      end subroutine ReadIA32_PMC5

      subroutine initIA32_PMC6(msr)
!DIR$  ATTRIBUTES CODE_ALIGN:32 :: initIA32_PMC6
           type(MSR_IA32_PMC6),       intent(inout) :: msr
           ! Exec code ....
           msr.msr_read = zero_val
      end subroutine initIA32_PMC6
...
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PMC6
     ...
     subroutine ReadIA32_PMC6(msr,iounit,fname,status,err,ermsg)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PMC6
           type(MSR_IA32_PMC6),                   intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           ...
           integer(kind=int4), automatic :: i,ioerr
           include 'GMS_imsrt_ra_body.inc'
     end subroutine ReadIA32_PMC6

     subroutine initIA32_PMC7(msr)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: initIA32_PMC7
           type(MSR_IA32_PMC7),          intent(inout) :: msr
           ! Exec code ....
           msr.msr_read = zero_val
     end subroutine initIA32_PMC7
...
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PMC7
     ...
     subroutine ReadIA32_PMC7(msr,iounit,fname,status,err,ermsg)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PMC7
           type(MSR_IA32_PMC7),                   intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
...
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_MTRRCAP
     ...
     subroutine ReadIA32_ARCH_CAPABILITIES(msr,iounit,fname,status,err,ermsg)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_ARCH_CAPABILITIES
           type(MSR_IA32_ARCH_CAPABILITIES),      intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           integer(kind=int4),                    intent(in)    :: err
           ...
           integer(kind=int4), automatic :: ioerr
           include 'GMS_imsrt_rs_body.inc'
     end subroutine ReadIA32_ARCH_CAPABILITIES
     ...
     subroutine AccessIA32_FLUSH_CMD(reg,op,command,fname,ier)
      ...
      subroutine AccessIA32_PERFEVTSEL0(reg,op,command,fname,ier)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PERFEVTSEL0
           type(MSR_IA32_PERFEVTSEL0),       intent(inout) :: reg
           character(len=5),                 intent(in) :: op
           character(len=*),                 intent(in) :: command
           !
           character(len=*),                 intent(in) :: fname
           ...
           ! Exec code ....
           include 'GMS_imsrt_ac_body.inc'
      end subroutine AccessIA32_PERFEVTSEL0
      
      subroutine ReadIA32_PERFEVTSEL0(msr,iounit,fname,status,err,ermsg)
!DIR$  ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PERFEVTSEL0
           type(MSR_IA32_PERFEVTSEL0),            intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           integer(kind=int4),                    intent(in)    :: err
           ...
           integer(kind=int4), automatic :: ioerr
           include 'GMS_imsrt_rs_body.inc'
     end subroutine ReadIA32_PERFEVTSEL0

     subroutine AccessIA32_PERFEVTSEL1(reg,op,command,fname,ier)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PERFEVTSEL1
           type(MSR_IA32_PERFEVTSEL1),       intent(inout) :: reg
           character(len=5),                 intent(in) :: op
           character(len=*),                 intent(in) :: command
           !
           character(len=*),                 intent(in) :: fname
           ...
           ! Exec code ....
           include 'GMS_imsrt_ac_body.inc'
      end subroutine AccessIA32_PERFEVTSEL1
      
      subroutine ReadIA32_PERFEVTSEL1(msr,iounit,fname,status,err,ermsg)
!DIR$  ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PERFEVTSEL1
           type(MSR_IA32_PERFEVTSEL1),            intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           integer(kind=int4),                    intent(in)    :: err
           ...
           integer(kind=int4), automatic :: ioerr
           include 'GMS_imsrt_rs_body.inc'
       end subroutine ReadIA32_PERFEVTSEL1

       subroutine AccessIA32_PERFEVTSEL2(reg,op,command,fname,ier)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PERFEVTSEL2
           type(MSR_IA32_PERFEVTSEL2),       intent(inout) :: reg
           character(len=5),                 intent(in) :: op
           character(len=*),                 intent(in) :: command
           !
           character(len=*),                 intent(in) :: fname
           ...
           ! Exec code ....
           include 'GMS_imsrt_ac_body.inc'
      end subroutine AccessIA32_PERFEVTSEL2
      
      subroutine ReadIA32_PERFEVTSEL2(msr,iounit,fname,status,err,ermsg)
!DIR$  ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PERFEVTSEL2
           type(MSR_IA32_PERFEVTSEL2),            intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           integer(kind=int4),                    intent(in)    :: err
           ...
           integer(kind=int4), automatic :: ioerr
           include 'GMS_imsrt_rs_body.inc'
       end subroutine ReadIA32_PERFEVTSEL2

       subroutine AccessIA32_PERFEVTSEL3(reg,op,command,fname,ier)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PERFEVTSEL3
           type(MSR_IA32_PERFEVTSEL3),       intent(inout) :: reg
           character(len=5),                 intent(in) :: op
           character(len=*),                 intent(in) :: command
           !
           character(len=*),                 intent(in) :: fname
           ...
           ! Exec code ....
           include 'GMS_imsrt_ac_body.inc'
      end subroutine AccessIA32_PERFEVTSEL3
      
      subroutine ReadIA32_PERFEVTSEL3(msr,iounit,fname,status,err,ermsg)
!DIR$  ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PERFEVTSEL3
           type(MSR_IA32_PERFEVTSEL0),            intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           ...
           integer(kind=int4), automatic :: ioerr
           include 'GMS_imsrt_rs_body.inc'
       end subroutine ReadIA32_PERFEVTSEL3

     subroutine AccessIA32_PERF_STATUS(reg,command,fname,ier)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: AccessIA32_PERF_STATUS
           type(MSR_IA32_PERF_STATUS),     intent(in) :: reg
           ! 
           character(len=*),           intent(in)    :: command
           character(len=*),           intent(in)    :: fname
           integer(kind=int2),         intent(inout) :: ier
     ...
     end subroutine AccessIA32_PERF_STATUS

     subroutine ReadIA32_PERF_STATUS(msr,iounit,fname,status,err,ermsg)
!DIR$ ATTRIBUTES CODE_ALIGN:32 :: ReadIA32_PERF_STATUS
           type(MSR_IA32_PERF_STATUS),            intent(inout) :: msr
           integer(kind=int4),                    intent(in)    :: iounit
           character(len=*),                      intent(in)    :: fname
           integer(kind=int2),                    intent(in)    :: status
           integer(kind=int4),                    intent(in)    :: err
           ...
           integer(kind=int4), automatic :: ioerr
           include 'GMS_imsrt_rs_body.inc'
     end subroutine ReadIA32_PERF_STATUS
