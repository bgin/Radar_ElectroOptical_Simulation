...
!DIR$ ATTRIBUTES ALIGN : 64 :: branches_sin_yangle
   ...
   contains
     ...
     subroutine InitTreeScatterer_AVX(DataCold,DataHot,nleaves,nbranches,nsteps,ordinal,trunk_param_npoints, &
                                  ...
                                  verbose,append,fname )                 !GCC$ ATTRIBUTES cold :: InitTreeScatterer_AVX  !GCC$ ATTRIBUTES aligned(32) :: InitTreeScatterer_AVX
     ...
     subroutine InitTreeScatterer_AVX(DataCold,DataHot,nleaves,nbranches,nsteps,ordinal,trunk_param_npoints, &
       ...
       !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: InitTreeScatterer_AVX
#endif
