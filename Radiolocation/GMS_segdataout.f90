...
9999      close(UNIT=iounit,STATUS='KEEP')
    ...
    subroutine copyNECWireDataOut_ymm4r8_ymm8i4(wo,               &
          ...
          copy_i4_ymm8i4(ymm8i4_wirenum,wo.m_wirenum)
          copy_r8_ymm4r8(ymm4r8_x1,     wo.m_x1)
          copy_r8_ymm4r8(ymm4r8_y1,     wo.m_y1)
          copy_r8_ymm4r8(ymm4r8_z1,     wo.m_z1)
          copy_r8_ymm4r8(ymm4r8_x2,     wo.m_x2)
          copy_r8_ymm4r8(ymm4r8_y2,     wo.m_y2)
          copy_r8_ymm4r8(ymm4r8_z2,     wo.m_z2)
          copy_r8_ymm4r8(ymm4r8_radius, wo.m_radius)
          copy_i4_ymm8i4(ymm8i4_nsegs,  wo.m_nsegs)
          copy_i4_ymm8i4(ymm8i4_firstseg, wo.m_firstseg)
          copy_i4_ymm8i4(ymm8i4_lastseg,  wo.m_lastseg)
          copy_i4_ymm8i4(ymm8i4_tagnum,   wo.m_tagnum)
          
    end subroutine copyNECWireDataOut
