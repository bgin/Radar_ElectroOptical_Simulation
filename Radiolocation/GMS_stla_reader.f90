...
module STLA_Reader
 ...
 !          
 !          Purpose:
 !                      J. Burkardt 'stla_io' implementation wrapped in
 !                      a module.
 !          History:
 !                        
 !                        Date: 01-01-2022
 ...
 !=================================================================================
     ...
     type, public :: STLA_Mesh
           ...
           real(kind=dp), allocatable, dimension(:,:)    :: node_xyz    ! NODE_XYZ(3,NODE_NUM), the coordinates of points.
           real(kind=dp), allocatable, dimension(:,:)    :: face_normal ! FACE_NORMAL(3,FACE_NUM), the normal vector at each face.
           integer(kind=i4), allocatable, dimension(:,:) :: face_node   ! FACE_NODE(3,FACE_NUM), the nodes that   make up each face.
           ...
           real(kind=dp), allocatable, dimension(:,:)    :: face_normal !GCC$ ATTRIBUTES aligned(64) :: face_normal
...
!
  ...
  integer ( kind = i4 ) face_node(3,face_num)
