...
#define LEAF_PHASE_MATRIX_AUTOVECTORIZE 0
   ...
   contains
     ...
     subroutine compute_leaf_phase_matrices(l4x4phm,l2x2mp,l2x2mn, &
                                            stokes4x4m, &
                                            scat2x2m,lvar,lvarv    &
                                            dens, &
     ...
     subroutine compute_leaf_phase_matrices(l4x4phm,l2x2mp,l2x2mn, &
           ...
           real(kind=sp),    automatic :: dp1t1,dp2t2,dp3t3,orient_distr,work
...
#endif
              do l=1,4
                 l4x4phm(l,k,i) =  work*(dp1t1*l4x4phm_t1(l,k,i)+ &
