...
module mod_chebyshev_hydrometeors_AVX512
 ...
 !
 !          Module  name:
 !                         'mod_chebyshev_hydrometeors_AVX512'
 !          
 !          Purpose:
  !                      This module models 'Chebyshev Particles' aggregated ensemble
 !                       Explicitly vectorized (AVX512)
 !                       
 !          History:
 !                        Date: 04-08-2018
 !                        Time: 11:51 GMT+2
 ...
 !==================================================================================85
    ...
    ! Major version
    integer(kind=int4),  parameter :: MOD_CHEBYSHEV_HYDROMETEORS_AVX512_MAJOR = 1
    
    ! Minor version
    integer(kind=int4),  parameter :: MOD_CHEBYSHEV_HYDROMETEORS_AVX512_MINOR = 0
    
    ! Micro version
    integer(kind=int4),  parameter :: MOD_CHEBYSHEV_HYDROMETEORS_AVX512_MICRO = 0
    
    ! Module full version
    integer(kind=int4),  parameter :: MOD_CHEBYSHEV_HYDROMETEORS_AVX512_FULLVER = 1000*MOD_CHEBYSHEV_HYDROMETEORS_AVX512_MAJOR + &
                                                                                100*MOD_CHEBYSHEV_HYDROMETEORS_AVX512_MINOR  + &
                                                                                10*MOD_CHEBYSHEV_HYDROMETEORS_AVX512_MICRO
    ! Module creation date
    character(*),        parameter :: MOD_CHEBYSHEV_HYDROMETEORS_AVX512_CREATE_DATE = "04-08-2018 11:41 +00200 (SAT 04 AUG 2018 GMT+2) "
    
    ! Module build date (  should be set after successful compilation)
    character(*),        parameter :: MOD_CHEBYSHEV_HYDROMETEORS_AVX512_BUILD_DATE = __DATE__ " " __TIME__
    
    ! Module author info
    character(*),        parameter :: MOD_CHEBYSHEV_HYDROMETEORS_AVX512_AUTHOR = "Programmer: Bernard Gingold, contact: beniekg@gmail.com"
    
    ! Module short description
    character(*),        parameter :: MOD_CHEBYSHEV_HYDROMETEORS_AVX512_DESCRIPT = "Model of aggregated chebyshev particles (hydrometeors)."
    ...
    ! Low spacial and temporal frequency derived data type
     ...
     type, public :: CHMColdAVX512_t
          ...
          type(ZMM16r4_t), allocatable, dimension(:,:)   :: m_pcs
          !DIR$     ATTRIBUTES ALIGN : 64 :: m_pcs
#elif defined __GFORTRAN__ && !defined __INTEL_COMPILER
          type(ZMM16r4_t), allocatable, dimension(:,:)   :: m_pcs  !GCC$ ATTRIBUTES aligned(64) :: m_pcs
#endif
          ...
          ! [paramx,np]
#if defined __ICC || defined __INTEL_COMPILER
          type(ZMM16r4_t), allocatable, dimension(:,:)    :: m_ppx
          !DIR$     ATTRIBUTES ALIGN : 64 :: m_ppx
#elif defined __GFORTRAN__ && !defined __INTEL_COMPILER
          type(ZMM16r4_t), allocatable, dimension(:,:)    :: m_ppx !GCC$ ATTRIBUTES aligned(64) :: m_ppx
#endif
          ! Chebyshev particles ensemble (per each particle)  parametric equation in y  - dimension (non-dimensional)
#if defined __ICC || defined __INTEL_COMPILER
          type(ZMM16r4_t), allocatable, dimension(:,:)    :: m_ppy
          !DIR$     ATTRIBUTES ALIGN : 64 :: m_ppy
#elif defined __GFORTRAN__ && !defined __INTEL_COMPILER
          type(ZMM16r4_t), allocatable, dimension(:,:)    :: m_ppy !GCC$ ATTRIBUTES aligned(64) :: m_ppy
#endif
          ! Chebyshev particles ensemble (per each particle)  parametric equation in z  - dimension (non-dimensional)
#if defined __ICC || defined __INTEL_COMPILER
          type(ZMM16r4_t), allocatable, dimension(:,:)    :: m_ppz
          !DIR$    ATTRIBUTES ALIGN : 64 :: m_ppz
#elif defined __GFORTRAN__ && !defined __INTEL_COMPILER
          type(ZMM16r4_t), allocatable, dimension(:,:)    :: m_ppz !GCC$ ATTRIBUTES aligned(64) :: m_ppz
#endif
     end type CHMColdAVX512_t


     ! High temporal and spatial freuqency derived data type.     
     type, public :: CHMHotAVX512_t
           public
...
#endif           
     end type CHMHotAVX512_t

       
   contains

#if defined __GFORTRAN__
     subroutine InitChebyshevHydroMeteors(DataCold,DataHot,np,id,nt,htype,esh,nxpts,nypts,  &     
              nzpts,msval,err,iounit,verbose,logging,filename,append)  !GCC$ ATTRIBUTES cold :: InitChebyshevHydroMeteors  !GCC$ ATTRIBUTES aligned(32) :: InitChebyshevHydroMeteors
#elif defined __INTEL_COMPILER
     subroutine InitChebyshevHydroMeteors(DataCold,DataHot,np,id,nt,htype,esh,nxpts,nypts,  &     
                                  nzpts,msval,err,iounit,verbose,logging,filename,append)
       !DIR$ ATTRIBUTES CODE_ALIGN:32 :: InitChebyshevHydroMeteors
#endif
           use mod_print_error, only : handle_fatal_memory_error
           type(CHMColdAVX512_t),             intent(in)       :: DataCold
           type(CHMHotAVX512_t),              intent(in)       :: DataHot
...
9999       call  handle_fatal_memory_error( iounit, logging,verbose,append,fname,                                                    &
                             "logger: "// __FILE__ // "module: mod_chebyshev_hydrometeors_AVX512, subroutine: InitChebyshevHydroMeteors -- Memory Allocation Failure !!",                           &                                       "module: mod_chebyshev_hydrometeors_AVX512, subroutine: InitChebyshevHydroMeteors -- Memory Allocation Failure !!", emsg, 304)
     end subroutine InitChebyshevHydroMeteors
  ...
  !===============================================================================
    ...
    ! sphere radius, deformity coefficient and T(n) curve.
     ...
     subroutine ComputeHydroMeteorsCS_ZMM16r4(pcs,radii,cn,cdef,msval,np) !GCC$ ATTRIBUTES hot :: ComputeHydroMeteorsCS_ZMM16r4 !GCC$ ATTIRBUTES aligned(32) :: ComputeHydroMeteorsCS_ZMM16r4
#elif defined __ICC || defined __INTEL_COMPILER
     subroutine ComputeHydroMeteorsCS_ZMM16r4(pcs,radii,cn,cdef,msval,np)
       !DIR$ ATTRIBUTES CODE_ALIGN:32 :: ComputeHydroMeteorsCS_ZMM16r4
#endif
           use mod_chebyshev_hydrometeors_common_AVX512, only : ComputeShape_ZMM16r4
           type(ZMM16r4_t),  contiguous, dimension(:,:),  intent(inout) :: pcs
           ...
           ! EXec code ...
           call ComputeShape_ZMM16r4(pcs,                    &
                                    pradii,                  &
                                    cn,                      &
                                    cdef,                    &
                                    msval,                   &
                                    np)
      end subroutine ComputeHydroMeteorsCS_ZMM16r4
    ...
    !
      !=================================================================71
#if defined __GFORTRAN__ && !defined __INTEL_COMPILER
    subroutine ComputeHMXparam_ZMM16r4(ppx,radii,cn,cdef,nxpts,np)  !GCC$ ATTRIBUTES hot :: ComputeHMXparam_ZMM16r4 !GCC$ ATTRIBUTES aligned(32) :: ComputeHMXparam_ZMM16r4
#elif defined __ICC || defined __INTEL_COMPILER
    subroutine ComputeXparam(ppx,radii,cn,cdef,nxpts,np)
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: ComputeHMXparam_ZMM16r4
#endif
           use mod_chebyshev_hydrometeors_common_AVX512, only : ComputeXparam_ZMM16r4
           type(ZMM16r4_t), contiguous, dimension(:,:), intent(inout) :: ppx
           real(kind=sp),   contiguous, dimension(:),   intent(in)    :: radii
           ...
           integer(kind=int4),                          intent(in)    :: np
           ! Exec code ....
           call ComputeXparam_ZMM16r4(ppx,   &
                                     radii, &
                                     cn,    &
                                     cdef,  &
                                     nxpts, &
                                     np)
     end subroutine ComputeHMXparam_ZMM16r4
    ...
    !==========================================================================80
#if defined __GFORTRAN__ && !defined __INTEL_COMPILER
    subroutine ComputeHMYparam_ZMM16r4(ppy,radii,cn,cdef,nypts,np) !GCC$ ATTRIBUTES hot :: ComputeHMYparam_ZMM16r4 !GCC$ ATTIRBUTES aligned(32) :: ComputeHMYparam_ZMM16r4
#elif defined __ICC || defined __INTEL_COMPILER
    subroutine ComputeHMYparam_ZMM16r4(ppy,radii,cn,cdef,nypts,np)
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: ComputeHMYparam_ZMM16r4
#endif
           use mod_chebyshev_hydrometeors_common_AVX512, only : ComputeYparam_ZMM16r4
           type(ZMM16r4_t),  contiguous, dimension(:,:), intent(inout) :: ppy
           real(kind=sp),    contiguous, dimension(:),   intent(in)    :: radii
           ...
           integer(kind=int4),                           intent(in)    :: np
           ! Exec code ....
           call ComputeYparam_ZMM16r4(ppy,   &
                                     radii, &
                                     cn,    &
                                     cdef,  &
                                     nypts, &
                                     np)
      end subroutine ComputeHMYparam_ZMM16r4
    ...
    !==========================================================================80
#if defined __GFORTRAN__ && !defined __INTEL_COMPILER
    subroutine ComputeHMZparam_ZMM16r4(ppz,radii,cn,cdef,nzpts,np) !GCC$ ATTRIBUTES hot :: ComputeHMZparam_ZMM16r4 !GCC$ ATTRIBUTES aligned(32) :: ComputeHMZparam_ZMM16r4
#elif defined __ICC || defined __INTEL_COMPILER
    subroutine ComputeHMZparam_ZMM16r4(ppz,radii,cn,cdef,nzpts,np)
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: ComputeHMZparam_ZMM16r4
#endif
           use mod_chebyshev_hydrometeors_common_AVX512, only : ComputeZparam_ZMM16r4
           type(ZMM16r4_t),  contiguous, dimension(:,:), intent(inout) :: ppz
           real(kind=sp),    contiguous, dimension(:),   intent(in)    :: radii
           real(kind=sp),    contiguous, dimension(:),   intent(inout) :: cn
           real(kind=sp),    contiguous, dimension(:),   intent(inout) :: cdef
           ...
           integer(kind=int4),                          intent(in)    :: np
           ! Exec code ....
           call ComputeZparam_ZMM16r4(ppz,   &
                                     radii, &
                                     cn,    &
                                     cdef,  &
                                     nzpts,    &
                                     np)
      end subroutine ComputeHMZparam_ZMM16r4
    ...
    !==========================================================================80
#if defined __GFORTRAN__ && !defined __INTEL_COMPILER
    subroutine  ComputeHMVolume_sAVX512(tpv,np,sphrad,chebn,cdeform)  !GCC$ ATTRIBUTES hot :: ComputeHMVolume_sAVX512 !GCC$ ATTRIBUTES aligned(32) :: ComputeHMVolume_sAVX512
#elif defined __ICC || defined __INTEL_COMPILER
    subroutine  ComputeHMVolume_sAVX512(tpv,np,sphrad,chebn,cdeform)
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: ComputeHMVolume_sAVX512
#endif
    ...
    end subroutine  ComputeHMVolume_sAVX512
    ...
    !==========================================================================80
#if defined __GFORTRAN__
    subroutine ComputeHMSurfuce_sAVX512(tps,np,sphrad,chebn,cdeform)  !GCC$ ATTRIBUTES hot :: ComputeHMSurface_sAVX512 !GCC$ ATTRIBUTES aligned(32) :: ComputeHMSurface_sAVX512
#elif defined __INTEL_COMPILER
    subroutine ComputeHMSurface_sAVX512(tps,np,sphrad,chebn,cdeform)
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: ComputeHMSurface_sAVX512
#endif
          use mod_constants, only : pi2_const
    ...
    end subroutine ComputeHMSurface_sAVX512
    ...
    !============================================================================
#if defined __GFORTRAN__ && !defined __INTEL_COMPILER
    subroutine ComputeHMVfall_sAVX512(pfv,nt,aRe,bRe,vb,kvisc,nx,ny,nz,A,rho_b,rho_f,mD, &
         Re,bRet,aRet                        )                    !GCC$ ATTRIBUTES hot :: ComputeHMVfall_sAVX512 !GCC$ ATTRIBUTES aligned(32) :: ComputeHMVfall_sAVX512
#elif  defined __ICC || defined __INTEL_COMPILER 
    subroutine ComputeHMVfall_sAVX512(pfv,nt,aRe,bRe,vb,kvisc,nx,ny,nz,A,rho_b,rho_f,mD, &
                             Re,bRet,aRet                        )
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: ComputeHMVfall_sAVX512
      !DIR$ ATTRIBUTES VECTOR :: ComputeHMVfall_sAVX512
#endif
    ...
    end subroutine   ComputeHMVfall_sAVX512      
         

end module mod_chebyshev_hydrometeors_AVX512
