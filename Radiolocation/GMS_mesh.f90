...
module mod_mesh
 ...
 !=================================================================================
    ...
    ! Major version
    integer(kind=i4), parameter, public :: MOD_MESH_MAJOR = 1
    
    ! Minor version
    integer(kind=i4), parameter, public :: MOD_MESH_MINOR = 0
    
    ! Micro version
    integer(kind=i4), parameter, public :: MOD_MESH_MICRO = 1
    
    ! Module full version
    integer(kind=i4), parameter, public :: MOD_MESH_FULLVERSION = 10004*MOD_MESH_MAJOR+100*MOD_MESH_MINOR+ &
                                                                    104*MOD_MESH_MICRO
