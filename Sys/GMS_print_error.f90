...
module mod_print_error
 ...
 ! Tab:10,11 col - Type , function and subroutine code blocks.
    ...
    !  handler
    !=====================================
    subroutine handle_fatal_memory_error(iounit,logging,verbose,append,fname,lmsg,umsg,emsg,line)
      ...
      use IFCORE, only :  TRACEBACKQQ
          ...
          integer(kind=i4),    intent(in) :: line
          ! Locals
          character(len=10) ::  stime
          character(len=8)  ::  sdate
          ! Start of executable statements
    ...
    !  handler
    !=====================================                               
       subroutine handle_fatal_fileio_error(iounit,logging,verbose,append,fname,filerr,lmsg,umsg,emsg,line)
#if defined(__INTEL_COMPILER) || defined(__ICC)   
      use IFCORE, only :  TRACEBACKQQ
#endif         
