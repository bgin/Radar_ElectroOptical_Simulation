...
module mod_code_timers
 ...
 ! Tab:10,11 col - Type , function and subroutine code blocks.
    ...
    use module_kinds, only : int4,int8b,sp,dp
#if defined _WIN64
    use kernel32
#endif
    ...
    ! Major version
    integer(kind=int4), parameter, public :: MOD_CODE_TIMERS_MAJOR = 1
    
    ! Minor version
    integer(kind=int4), parameter, public :: MOD_CODE_TIMERS_MINOR = 0
    
    ! Micro version
    integer(kind=int4), parameter, public :: MOD_CODE_TIMERS_MICRO = 0
    
    ! Module/file full version
    integer(kind=int4), parameter, public :: MOD_CODE_TIMERS_FULLVER = 1000*MOD_CODE_TIMERS_MAJOR+100*MOD_CODE_TIMERS_MINOR + &
    ...
    type, public :: SCTimer_t
        ...
        integer(kind=int4) :: m_loc ! line of measured code.
    ...
    type, public  :: QPCTimer_t
        ...
        real(kind=dp)    :: m_delta
        
        real(kind=dp) :: m_cpufreq  
    ...
    subroutine sctimer_delta(this,ifail)
          ...
          type(SCTimer_t),      intent(inout) :: this
          logical(kind=int4),   intent(out)   :: ifail
          ! Start of executable statements
...
30        format(" 4) delta value=",F10.15)
    ...
    subroutine qpctimer_start(this,ifail)
          ...
          this%m_cpufreq = DBLE(tmp)*0.001_dp
