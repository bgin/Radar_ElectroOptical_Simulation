...
#include "GMS_avx2_transposition_8x8.h"
                ...
                void
                transpose_ymm8r4_8x8_ip(__m256 * __restrict x0,
		                        __m256 * __restrict x1,
			                __m256 * __restrict x2,
			                __m256 * __restrict x3,
			                __m256 * __restrict x4,
			                __m256 * __restrict x5,
			                __m256 * __restrict x6,
			                __m256 * __restrict x7) {
		 ...
		 void
                 transpose_u_ymm8r4_8x8_ip(float * __restrict x0,
		                           float * __restrict x1,
			                   float * __restrict x2,
			                   float * __restrict x3,
			                   float * __restrict x4,
	        ...
	        void
                transpose_a_ymm8r4_8x8_ip(float * __restrict __attribute__((aligned(32))) x0,
		                          float * __restrict __attribute__((aligned(32))) x1,
			                  float * __restrict __attribute__((aligned(32))) x2,
			                  float * __restrict __attribute__((aligned(32))) x3,
			                  float * __restrict __attribute__((aligned(32))) x4,
			                  float * __restrict __attribute__((aligned(32))) x5,
			                  float * __restrict __attribute__((aligned(32))) x6,
			                  float * __restrict __attribute__((aligned(32))) x7) {
		 ...
		 void
                 transpose_u_ymm8r4_8x8_ip_v2(float * __restrict x) {
		   ...
		   void
                   transpose_a_ymm8r4_8x8_ip_v2(float * __restrict __attribute__((aligned(32))) x) {
		  ...
		  void
                  transpose_u_ymm8r4_8x8(float * __restrict x,
                                         float * __restrict y) {
		  ...
		  void
                  transpose_a_ymm8r4_8x8(float * __restrict __attribute__((aligned(32))) x,
                                         float * __restrict __attribute__((aligned(32))) y) {
	         ...
	         void
                 transpose_u_ymm8r4_8x8_v2(float * __restrict x,
		                           float * __restrict y,
				           const int32_t n) {
...
#pragma code_align(32)
	        ...
	        void
                transpose_a_ymm8r4_8x8_v2(float * __restrict __attribute__((aligned(32))) x,
		                          float * __restrict __attribute__((aligned(32))) y,
				          const int32_t n) {
