...
#ifndef __GMS_RANGE_RATE_AVX512PS_H__
#define __GMS_RANGE_RATE_AVX512PS_H__ 140520221111
...
*/
 ...
 const unsigned int gGMS_RANGE_RATE_AVX512PS_MAJOR = 1U;
 const unsigned int gGMS_RANGE_RATE_AVX512PS_MINOR = 0U;
 const unsigned int gGMS_RANGE_RATE_AVX512PS_MICRO = 0U;
 const unsigned int gGMS_RANGE_RATE_AVX512PS_FULLVER =
  1000U*gGMS_RANGE_RATE_AVX512PS_MAJOR+100U*gGMS_RANGE_RATE_AVX512PS_MINOR+10U*gGMS_RANGE_RATE_AVX512PS_MICRO;
 const char * const pgGMS_RANGE_RATE_AVX512PS_CREATION_DATE = "14-05-2022 11:11 +00200 (SAT 14 MAY 2022 11:11 GMT+2)";
 const char * const pgGMS_RANGE_RATE_AVX512PS_BUILD_DATE    = __DATE__ " " __TIME__ ;
 const char * const pgGMS_RANGE_RATE_AVX512PS_AUTHOR        = "Programmer: Bernard Gingold, contact: beniekg@gmail.com";
 const char * const pgGMS_RANGE_RATE_AVX512PS_SYNOPSIS      = "AVX512 based range-rate functions (vectorized)."
 ...
 **/
  ...
  __m512
  range_rate_2d_zmm16r4(const __m512,
		       const __m512,
		       const __m512,
		       const __m512,
		       const __m512,
 ...
 **/
 ...
 __m512
 range_rate_3d_zmm16r4(const __m512,
		      const __m512,
		      const __m512,
		      const __m512,
		      const __m512,
...
/*(UNCLASSIFIED) DISTRIBUTION STATEMENT A. Approved for public release.*/
 ...
 __m512
 range_grad_zmm16r4(const __m512,
		   const __m512,
		   const __m512,
		   const bool)   __attribute__((noinline))
			           __attribute__((hot))
...
/*(UNCLASSIFIED) DISTRIBUTION STATEMENT A. Approved for public release.*/
 ...
 __m512
 range_hessian_1d_zmm16r4()         __attribute__((noinline))
			           __attribute__((hot))
				   __attribute__((regcall))
				   __attribute__((aligned(32)));
 ...
 void
 range_hessian_3d_zmm16r4(__m512 * __restrict,
		         const __m512,
			 const __m512,
			 const __m512,
			 const bool ) __attribute__((noinline))
 ...
 __m512
 range_hess_gen_1d_zmm16r4()             __attribute__((noinline))
			                __attribute__((hot))
				        __attribute__((regcall))
				        __attribute__((aligned(32)));
...
void
range_hess_gen_2d_zmm16r4(__m512 * __restrict,
		         __m512 * __restrict,
			 __m512 * __restrict,
			 __m512 * __restrict,
			 const __m512,
...
void
range_hess_3d_zmm16r4(__m512 * __restrict,
		     __m512 * __restrict,
		     __m512 * __restrict,
		     __m512 * __restrict,
		     __m512 * __restrict,
...
void
cart_to_ruv_zmm16r4(__m512 * __restrict,
		   __m512 * __restrict,
		   __m512 * __restrict,
		   __m512 * __restrict,
		   const __m512,
		   ...
		   const __m512,
		   const __m512,
		   const __m512 * __restrict , //flattened 3x3 matrix
		   const bool )          __attribute__((noinline))
			                 __attribute__((hot))
				         __attribute__((regcall))
				         __attribute__((aligned(32)));
...
void
cart_to_sphere_zmm16r4(__m512 * __restrict,
		      __m512 * __restrict,
		      __m512 * __restrict,
		      const __m512,
		      const __m512,
