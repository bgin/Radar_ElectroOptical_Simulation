...
#ifndef __GMS_POS_TO_STATE_AVX512PS_H__
#define __GMS_POS_TO_STATE_AVX512PS_H__
...
*/
 ...
 const unsigned int GMS_POS_TO_STATE_AVX512PS_MAJOR = 1U;
 const unsigned int GMS_POS_TO_STATE_AVX512PS_MINOR = 0U;
 const unsigned int GMS_POS_TO_STATE_AVX512PS_MICRO = 0U;
 const unsigned int GMS_POS_TO_STATE_AVX512PS_FULLVER =
  1000U*GMS_POS_TO_STATE_AVX512PS_MAJOR+100U*GMS_POS_TO_STATE_AVX512PS_MINOR+10U*GMS_POS_TO_STATE_AVX512PS_MICRO;
 const char * const GMS_POS_TO_STATE_AVX512PS_CREATION_DATE = "22-05-2022 15:52 +00200 (SUN 22 MAY 2022 15:52 GMT+2)";
 const char * const GMS_POS_TO_STATE_AVX512PS_BUILD_DATE    = __DATE__ " " __TIME__ ;
 const char * const GMS_POS_TO_STATE_AVX512PS_AUTHOR        = "Programmer: Bernard Gingold, contact: beniekg@gmail.com";
 const char * const GMS_POS_TO_STATE_AVX512PS_SYNOPSIS      = "AVX512 (single-precision) based position [2D] to state convertion functions (vectorized)."


#include <immintrin.h>
#include <stdint.h>
	 
#if !defined(POS_TO_STATE_AVX512PS_SLEEF_LIB)
#define POS_TO_STATE_AVX512PS_SLEEF_LIB 1
#endif
...
void
const_velocity_zmm16r4(const __m512,
                      const __m512,
		      __m512 * __restrict,
...
void
const_velocity_zmm16r4_a(const __m512,
                        const __m512,
		        float * __restrict,
...
void
const_velocity_zmm16r4_u(const __m512,
                        const __m512,
		        float * __restrict,
		        float * __restrict)   __attribute__((noinline))
			                       __attribute__((hot))
...
void
const_acceleration_zmm16r4(const __m512,
                          const __m512,
			  const __m512,
			  const __m512,
			  __m512 * __restrict,
...
void
const_acceleration_zmm16r4_a(const __m512,
                            const __m512,
			    const __m512,
			    const __m512,
			    float * __restrict,
...
void
const_acceleration_zmm16r4_u(const __m512,
                            const __m512,
			    const __m512,
			    const __m512,
			    float * __restrict,
...
void
const_turn_zmm16r4(const __m512,
                  const __m512,
		  const __m512,
		  const __m512,
		  __m512 * __restrict,
...
void
const_turn_zmm16r4_a(const __m512,
                    const __m512,
		    const __m512,
		    const __m512,
		    float * __restrict,
...
void
const_turn_zmm16r4_u(const __m512,
                    const __m512,
		    const __m512,
		    const __m512,
		    float * __restrict,
...
void
turn_accelerate_zmm16r4(const __m512,
                       const __m512,
		       const __m512,
		       const __m512,
		       __m512 * __restrict,
...
void
turn_accelerate_zmm16r4_a(const __m512,
                         const __m512,
		         const __m512,
		         const __m512,
		         float * __restrict,
...
void
turn_accelerate_zmm16r4_u(const __m512,
                         const __m512,
		         const __m512,
		         const __m512,
		         float * __restrict,
...
void
const_pol_vel_zmm16r4(const __m512,
                     const __m512,
		     __m512 * __restrict,
		     __m512 * __restrict) __attribute__((noinline))
			                   __attribute__((hot))
...
void
const_pol_vel_zmm16r4_a(const __m512,
                       const __m512,
		       float * __restrict,
		       float * __restrict) __attribute__((noinline))
			                    __attribute__((hot))
...
void
const_pol_vel_zmm16r4_u(const __m512,
                       const __m512,
		       float * __restrict,
		       float * __restrict) __attribute__((noinline))
			                    __attribute__((hot))
...
void
const_pol_accel_zmm16r4(const __m512,
                       const __m512,
		       const __m512,
		       __m512 * __restrict,
		       __m512 * __restrict,
...
void
const_pol_accel_zmm16r4_a(const __m512,
                         const __m512,
		         const __m512,
		         float * __restrict,
		         float * __restrict,
...
void
const_pol_accel_zmm16r4_u(const __m512,
                         const __m512,
		         const __m512,
		         float * __restrict,
		         float * __restrict,
...
void
const_pol_turn_zmm16r4( const __m512,
                       const __m512,
		       const __m512,
		       __m512 * __restrict,
		       __m512 * __restrict,
...
void
const_pol_turn_zmm16r4_a( const __m512,
                       const __m512,
		       const __m512,
		       float * __restrict,
		       float * __restrict,
...
void
const_pol_turn_zmm16r4_u( const __m512,
                         const __m512,
		         const __m512,
		         float * __restrict,
		         float * __restrict,
...
#endif /*__GMS_POS_TO_STATE_AVX512PS_H__*/
