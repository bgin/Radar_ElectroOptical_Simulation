		   ...
		   void
	        ...
	        transpose_a_zmm16r4_16x16(float * __restrict __attribute__((aligned(64))) x,
			   ...
			   _mm512_store_ps(&y[15*16],_mm512_shuffle_f32x4(y07,y15,0xdd);
                ...
                void
                transpose_u_zmm16r4_16x16_looped(float * __restrict x,
	                                         float * __restrict y,
					         const int32_t n) {
...
#pragma code_align(32)
	        ...
	        void
                transpose_a_zmm16r4_16x16_looped(float * __restrict __attribute__((aligned(64))) x,
	                                         float * __restrict __attribute__((aligned(64))) y,
					         const int32_t n) {
