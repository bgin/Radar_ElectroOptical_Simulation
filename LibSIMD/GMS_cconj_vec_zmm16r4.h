...
#include <immintrin.h>
 ...
 void cconjv_zmm16r4_unroll_16x_a(const float * __restrict __attribute__((aligned(64))) xim,
                                  float * __restrict __attribute__((aligned(64))) cxim,
                                  const int32_t n)
 ...
 void cconjv_zmm16r4_unroll_10x_a(const float * __restrict __attribute__((aligned(64))) xim,
                                  float * __restrict __attribute__((aligned(64))) cxim,
                                  const int32_t n)
...
void cconjv_zmm16r4_unroll_6x_a(const float * __restrict __attribute__((aligned(64))) xim,
                                float * __restrict __attribute__((aligned(64))) cxim,
                                const int32_t n) 
