...
#include "GMS_derivative_5P4P_avx2.h"


	            __m256d
	            stencil_5P_central_ymm4r8(__m256d (*f) (__m256d),
			                      __m256d vx,
					      __m256d vh,
					      __m256d * __restrict verr_ro,
					      __m256d * __restrict verr_tr) {
		       	...
		       	__m256d
			stencil_4P_forward_ymm4r8(__m256d (*f)(__m256d),
			                          __m256d vx,
						  __m256d vh,
						  __m256d * __restrict verr_ro,
						  __m256d * __restrict verr_tr) {
