...
#if !defined(CADD_VEC_ZMM16R4_INTERLEAVE_OPS)
#define CADD_VEC_ZMM16R4_INTERLEAVE_OPS 1
#endif

void 
cadd_zmm16r4_unroll_16x_u(const float * __restrict  xre,
...
#if (CADD_VEC_ZMM16R4_INTERLEAVE_OPS) == 1
...
void 
cadd_zmm16r4_unroll_16x_a(const float * __restrict  __attributes__((aligned(64))) xre,
                          const float * __restrict  __attributes__((aligned(64))) xim,
                          const float * __restrict  __attributes__((aligned(64))) yre,
                          const float * __restrict  __attributes__((aligned(64))) yim,
                          float * __restrict        __attributes__((aligned(64))) zre,
                          float * __restrict        __attributes__((aligned(64))) zim,
                          const int32_t n) {
...
void cadd_zmm16r4_unroll_10x_a(const float * __restrict  __attributes__((aligned(64))) xre,
                               const float * __restrict  __attributes__((aligned(64))) xim,
                               const float * __restrict  __attributes__((aligned(64))) yre,
                               const float * __restrict  __attributes__((aligned(64))) yim,
                               float * __restrict        __attributes__((aligned(64))) zre,
...
void cadd_zmm16r4_unroll_6x_a( const float * __restrict  __attributes__((aligned(64))) xre,
                               const float * __restrict  __attributes__((aligned(64))) xim,
                               const float * __restrict  __attributes__((aligned(64))) yre,
                               const float * __restrict  __attributes__((aligned(64))) yim,
                               float * __restrict        __attributes__((aligned(64))) zre,
...
void cadds_zmm16r4_unroll_16x_u(const float * __restrict xre,
                                const float * __restrict xim, 
                                const __m512             vs,
                                float  * __restrict zre,
                                float  * __restrict zim,
 ...
 void cadd_zmm16r4_unroll_16x_a(const float * __restrict __attributes__((aligned(64))) xre,
                                const float * __restrict __attributes__((aligned(64))) xim, 
                                const __m512             vs,
                                float  * __restrict __attributes__((aligned(64))) zre,
                                float  * __restrict __attributes__((aligned(64))) zim,
...
void cadds_zmm16r4_unroll_10x_u(const float * __restrict xre,
                                const float * __restrict xim, 
                                const __m512             vs,
                                float  * __restrict zre,
                                float  * __restrict zim,
...
void cadds_zmm16r4_unroll_10x_a(const float * __restrict __attributes__((aligned(64))) xre,
                                const float * __restrict __attributes__((aligned(64))) xim, 
                                const __m512             vs,
                                float  * __restrict __attributes__((aligned(64))) zre,
                                float  * __restrict __attributes__((aligned(64))) zim,
...
void cadds_zmm16r4_unroll_6x_u(const float * __restrict xre,
                              const float * __restrict xim, 
                              const __m512             vs,
                              float  * __restrict zre,
                              float  * __restrict zim,
...
void cadds_zmm16r4_unroll_6x_a( const float * __restrict __attributes__((aligned(64))) xre,
                                const float * __restrict __attributes__((aligned(64))) xim, 
                                const __m512             vs,
                                float  * __restrict __attributes__((aligned(64))) zre,
                                float  * __restrict __attributes__((aligned(64))) zim,
