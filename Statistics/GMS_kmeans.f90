...
module GMS_kmeans  
 ...
 !          Modified:      16-08-2023, 05:10PM GMT+2
 !
 !          Version:
 !
 !                      Major: 1
...
!
  ...
  integer ( kind = i4 ) cluster_num
  integer ( kind = i4 ) dim_num
  integer ( kind = i4 ) point_num

  integer ( kind = i4 ), dimension ( point_num ) :: cluster
...
!
  ...
  real ( kind = dp ) cluster_center(dim_num,cluster_num)
  integer ( kind = i4 ) cluster_population(cluster_num)
  integer ( kind = i4 ) i
...
!
  ...
  integer ( kind = i4 ) cluster(point_num)
  real ( kind = dp ) cluster_center(dim_num,cluster_num)
  integer ( kind = i4 ) cluster_population(cluster_num)
  real ( kind = dp ) cluster_variance(cluster_num)
  integer ( kind = i4 ) i
...
!
  ...
  integer   ( kind = i4 )   column_num
  logical                  got_one
  character ( len = * )    input_filename
  integer   ( kind = i4 )   input_status
  integer   ( kind = i4 )   input_unit
...
!
  ...
  integer   ( kind = i4 )   comment_num
  integer   ( kind = i4 )   ierror
  character ( len = * )    input_filename
  integer   ( kind = i4 )   input_status
  integer   ( kind = i4 )   input_unit
  character ( len = 255 )  line
  integer   ( kind = i4 )   record_num
  integer   ( kind = i4 )   row_num
...
!
  ...
  real ( kind = dp ), dimension ( dim_num, cluster_num ) :: cluster_center
  real ( kind = dp ), dimension ( cluster_num ) :: cluster_energy
  integer ( kind = i4 ), dimension ( cluster_num ) :: cluster_population
  logical, parameter :: debug = .true.
  integer ( kind = i4 )  i
  integer ( kind = i4 ) it_max
  integer ( kind = i4 ) it_num
  integer ( kind = i4 ) j
  integer ( kind = i4 ) missed
  real ( kind = dp ), dimension ( dim_num, point_num ) :: point
  real ( kind = dp ) point_energy
  real ( kind = dp ) point_energy_min
  integer ( kind = i4 ) swap
!
!  Data checks.
!
...
!
  ...
  integer ( kind = i4 ) c
  real ( kind = dp ), dimension ( dim_num, cluster_num ) :: centroid
  integer ( kind = i44 ), dimension ( point_num ) :: cluster
  real ( kind = dp ), dimension ( dim_num, cluster_num ) :: cluster_center
  real ( kind = dp ), dimension ( cluster_num ) :: cluster_energy
  integer ( kind = i4 ), dimension ( cluster_num ) :: cluster_population
...
!
  ...
  integer ( kind = i4 ) cluster_num
  integer ( kind = i44 ) dim_num
  integer ( kind = i4 ) point_num

  real ( kind = dp ) an1(cluster_num)
  real ( kind = dp ) an2(cluster_num)
  integer ( kind = i4 ) cluster(point_num)
  integer ( kind = i44 ) cluster2(point_num)
  real ( kind = dp ) cluster_center(dim_num,cluster_num)
  real ( kind = dp ) cluster_energy(cluster_num)
  integer ( kind = i4 ) cluster_population(cluster_num)
  ...
  real ( kind = dp ) dt(2)
  integer ( kind = i4 ) i 
  integer ( kind = i4 ) ifault
  integer ( kind = i4 ) il
  integer ( kind = i4 ) indx
  integer ( kind = i4 ) it_max
  integer ( kind = i4 ) it_num
  integer ( kind = i4 ) itran(cluster_num)
  integer ( kind = i4 ) j
  integer ( kind = i4 ) l
  integer ( kind = i4 ) live(cluster_num)
  integer ( kind = i4 ) ncp(cluster_num)
  real ( kind = dp ) point(dim_num,point_num)
  real ( kind = dp ) temp
...
!
  ...
  real ( kind = dp ) an2(cluster_num)
  integer ( kind = i4 ) cluster(point_num)
  integer ( kind = i4 ) cluster2(point_num)
  real ( kind = dp ) cluster_center(dim_num,cluster_num)
  integer ( kind = i4 ) cluster_population(cluster_num)
  real ( kind = dp ) d(point_num)
  real ( kind = dp ) dc
...
!
  ...
  logical blank
  integer ( kind = i4 ) i
  integer ( kind = i4 ) lens
  integer ( kind = i4 ) nword
  character ( len = * ) s
