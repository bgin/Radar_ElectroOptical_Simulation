...
*
      ...
      SUBROUTINE ADBAYS( NDIM, NUMFUN, A, B, MINPTS, MAXPTS, FUNSUB,        &
           ...
           !DIR$ ATTRIBUTES INLINE :: ADBAYS
           !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: ADBAYS
#endif
#if 0
...
#if defined(_OPENMP)
!$OMP THREADPRIVATE(NSUB,CLTOTL,CLINT)
#endif
!*
...
!*!
      ...
      SUBROUTINE BASCHC( MAXDIM, NDIM, NUMFUN, A, B, MINPTS, MAXPTS,        &
          ...
          NUM, NSUB, MAXSUB, MINSUB, IFAIL )
           use mod_kinds, only : i4,dp
#if defined (__INTEL_COMPILER)
           !DIR$ ATTRIBUTES INLINE :: BASCHC
           !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: BASCHC
#endif
#if 0
...
*
#endif
      INTEGER(kind=i4) NDIM, NUMFUN, MINPTS, MAXPTS, KEY, NW, MAXSUB, RESTAR
      INTEGER(kind=i4) NSUB, NUM, IFAIL, MAXDIM, MINSUB
      REAL(kind=dp) A(NDIM), B(NDIM), EPSABS, EPSREL
!*
!*     Local variables.
!*
      INTEGER(kind=i4) LIMIT,J
!*
...
!*
      INTEGER(kind=i4) I, J, INTSGN, SBRGNS, POINTR, DIRECT, WTLENG 
...
!*
      ...
      REAL(kind=dp) FRTHDF, DIFMAX, DIFSUM
      DIVAXN = 1
      DO I = 1,NDIM 
...
!
      ...
      REAL(kind=dp) C(*), H(*), EMX(*), S(NF,*), E(NF,*)
      IPTS = 0
      IF ( IR .EQ. 0 ) THEN
         C(1) = ( B + A )/2
         H(1) = ( B - A )/2
