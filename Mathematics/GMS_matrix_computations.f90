...
module mod_matrix_computations
 ...
 !=================================================================================
     ...
     ! File version info
     ! Major version
     integer(kind=i4),  parameter :: MOD_MATRIX_COMPUTATIONS_MAJOR = 1
     ! Minor version
     integer(kind=i4),  parameter :: MOD_MATRIX_COMPUTATIONS_MINOR = 0
     ! mICRO VERSION
     integer(kind=i4),  parameter :: MOD_MATRIX_COMPUTATIONS_MICRO = 0
     ! Full version
     integer(kind=i4),  parameter :: MOD_MATRIX_COMPUTATIONS_FULLVER = &
     ...
     subroutine invmat4x4_cr4(in,out)
         !DIR$ ATTRIBUTES CODE_ALIGN : 64 :: invmat4x4_cr4
          ...
          integer(kind=i4), dimension(4) :: ipvt
          real(kind=sp)      :: r
          integer(kind=i4) :: job
          ! Exec code
          out = in
...
!
      ...
      subroutine cgeco(a,lda,n,ipvt,rcond,z) !GCC$ ATTRIBUTES hot :: cgeco !GCC$ ATTRIBUTES aligned(16) :: cgeco
        ...
        subroutine cgeco(a,lda,n,ipvt,rcond,z)
          ...
          integer(kind=i4),                    intent(in)       :: lda
          integer(kind=i4),                    intent(in)       :: n
          integer(kind=i4),  dimension(n),     intent(inout)    :: ipvt
...
!    ISBN13: 978-0-898711-72-1,
     ...
     subroutine cgefa(a,lda,n,ipvt,info)
       !DIR$ ATTRIBUTES CODE_ALIGN : 16 :: cgefa
          ...
          integer(kind=i4),                     intent(in)    :: lda
          integer(kind=i4),                     intent(in)    :: n
          integer(kind=i4),  dimension(n),      intent(out)   :: ipvt
...
!    ISBN13: 978-0-898711-72-1,
     ...
     function icamax(n,x,incx)
         ...
         integer(kind=i4),              intent(in) :: incx
         ! Locals
         integer(kind=i4) :: icamax
         real(kind=sp) :: smax
         icamax = 0
...
!
     ...
     subroutine cgedi(a,lda,n,ipvt,det,work,job)
        ...
        integer(kind=i4),                  intent(in)    :: lda
        integer(kind=i4),                  intent(in)    :: n
        integer(kind=i4), dimension(n),    intent(in)    :: ipvt
