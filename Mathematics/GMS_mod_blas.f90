...
subroutine gms_zaxpy(n,za,zx,incx,zy,incy) !GCC$ ATTRIBUTES inline :: gms_zaxpy !GCC$ ATTRIBUTES aligned(32) :: gms_zaxpy
  ...
  subroutine gms_zaxpy(n,za,zx,incx,zy,incy)
      ...
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: gms_zaxpy
       !DIR$ OPTIMIZE : 3
    !DIR$ ATTRIBUTES OPTIMIZATION_PARAMETER: TARGET_ARCH=skylake_avx512 :: gms_zaxpy
#endif
      use omp_lib
...
!*>
#if defined(__GFORTRAN__) && (!defined(__ICC) || !defined(__INTEL_COMPILER))
    subroutine gms_zcopy(n,zx,incx,zy,incy) !GCC$ ATTRIBUTES inline :: gms_zcopy !GCC$ ATTRIBUTES aligned(32) :: gms_zcopy
...
!*> \endverbatim
#if defined(__GFORTRAN__) && (!defined(__ICC) || !defined(__INTEL_COMPILER))    
    function gms_zdotc(n,zx,incx,zy,incy) result(dotc) !GCC$ ATTRIBUTES inline :: gms_zdotc !GCC$ ATTRIBUTES aligned(32) :: gms_zdotc
#if defined __INTEL_COMPILER
    function gms_zdotc(n,zx,incx,zy,incy) result(dotc) 
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: gms_zdotc
       !DIR$ ATTRIBUTES FORCEINLINE :: gms_zdotc
        !DIR$ OPTIMIZE : 3
        !DIR$ ATTRIBUTES OPTIMIZATION_PARAMETER: TARGET_ARCH=skylake_avx512 :: gms_zdotc
#endif
      integer(kind=i4),                              intent(in),value :: n
      type(AVX512c8f64_t), dimension(:), allocatable,  intent(in)       :: zx
      integer(kind=i4),                              intent(in),value :: incx
...
!*> \endverbatim
#if defined(__GFORTRAN__) && (!defined(__ICC) || !defined(__INTEL_COMPILER))   
    function gms_zdotu(n,zx,incx,zy,incy) result(zdotu) !GCC$ ATTRIBUTES inline :: gms_zdotu !GCC$ ATTRIBUTES aligned(32) :: gms_zdotu
#if defined(__INTEL_COMPILER) || defined(__ICC)
     function gms_zdotu(n,zx,incx,zy,incy) result(zdotu)  
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: gms_zdotu
       !DIR$ ATTRIBUTES FORCEINLINE :: gms_zdotu
        !DIR$ OPTIMIZE : 3
        !DIR$ ATTRIBUTES OPTIMIZATION_PARAMETER: TARGET_ARCH=skylake_avx512 :: gms_zdotu
#endif
      integer(kind=i4),                                intent(in),value :: n
      type(AVX512c8f64_t), dimension(:), allocatable,  intent(in)       :: zx
      integer(kind=i4),                                intent(in),value :: incx
