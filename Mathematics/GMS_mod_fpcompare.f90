...
MODULE mod_fpcompare
  ...
  USE mod_vectypes, ONLY : XMM2i4_t, XMM4i4_t, XMM2r8_t, XMM4r4_t,YMM4r8_t,YMM8r4_t,ZMM16r4_t,ZMM8r8_t, &
...
!DIR$ ATTRIBUTES INLINE :: ymm4r8_equalto_ymm4r8
  ...
  pure elemental function ymm8r4_rgt_ymm8r4(x,y) result(gt)
    ...
    logical(kind=int4), automatic :: tmp
    ! Exec code ....
    vtmp.m = (x.v-y.v) >= SPACING(MAX(ABS(x.v),ABS(y.v)))
    tmp = vtmp.m(0).and.vtmp.m(1).and.vtmp.m(2).and.vtmp.m(3) .and. &
         vtmp.m(4).and.vtmp.m(5).and.vtmp.m(6).and.vtmp.m(7)
    if(tmp) then
       gt.m = .true.
    else
       gt.m = .false.
  ...
  pure elemental function zmm16r4_rgt_zmm16r4(x,y) result(gt)
    ...
    logical(kind=int4), automatic :: tmp1,tmp2
    ! Exec code ....
    vtmp.m = (x.v-y.v) >= SPACING(MAX(ABS(x.v),ABS(y.v)))
    tmp1 = vtmp.m(0).and.vtmp.m(1).and.vtmp.m(2).and.vtmp.m(3) .and. &
         vtmp.m(4).and.vtmp.m(5).and.vtmp.m(6).and.vtmp.m(7)
    tmp2 = vtmp.m(8).and.vtmp.m(9).and.vtmp.m(10) .and. &
         vtmp.m(11).and.vtmp.m(12).and.vtmp.m(13).and.vtmp.m(14).and.vtmp.m(15)
  ...
  pure elemental function xmm4r4_rlt_xmm4r4(x,y) result(gt)
    ...
    !  EXec code.....
    vtmp.m = (y.v-x.v) >= SPACING(MAX(ABS(x.v),ABS(y.v)))
    tmp = vtmp.m(0).and.vtmp.m(1).and.vtmp.m(2).and.vtmp.m(3)
    if(tmp) then
       gt.m = .true.
    else
       gt.m = .false.
  ...
  pure elemental function ymm8r4_rlt_ymm8r4(x,y) result(gt)
    ...
    type(Mask8_t) :: gt
    type(Mask8_t), automatic :: vtmp
    integer(kind=int4), automatic :: tmp
    ! Exec code ...
    vtmp.m = (y.v-x.v) >= SPACING(MAX(ABS(x.v),ABS(y.v)))
    tmp = vtmp.m(0).and.vtmp.m(1).and.vtmp.m(2).and.vtmp.m(3) .and. &
         vtmp.m(4).and.vtmp.m(5).and.vtmp.m(6).and.vtmp.m(7)
  ...
  pure elemental function zmm16r4_rlt_zmm16r4(x,y) result(gt)
    ...
    tmp1 = vtmp.m(0).and.vtmp.m(1).and.vtmp.m(2).and.vtmp.m(3) .and. &
         vtmp.m(4).and.vtmp.m(5).and.vtmp.m(6).and.vtmp.m(7)
    tmp2 = vtmp.m(8).and.vtmp.m(9).and.vtmp.m(10).and.vtmp.m(11) .and. &
         vtmp.m(12).and.vtmp.m(13).and.vtmp.m(14).and.vtmp.m(15)
    if(tmp1.and.tmp2) then
       gt.m = .true.
    else
       gt.m = .false.
...
!DIR$ ATTRIBUTES ALIGN : 64 :: e
  ...
  pure elemental function xmm2r8_cwt_xmm2r8(x,y,n,cutoff) result(isc)
    ...
    isc = .true.
    vtmp1.m = ABS(x.v) > c.v
    tmp1 = vtmp1.m(0).and.vtmp1.m(1)
    vtmp2.m = ABS(y.v) > c.v
    tmp2 = vtmp2.m(0).and.vtmp2.m(1)
...
!DIR$ ATTRIBUTES INLINE :: xmm4r4_cwt_xmm4r4
  pure elemental function xmm4r4_cwt_xmm4r4(x,y,n,cutoff) result(isc)
    ...
    isc = .true.
    vtmp1.m = ABS(x.v) > c.v
    tmp1 = vtmp1.m(0).and.vtmp1.m(1).and.vtmp.m(2).and.vtmp.m(3)
    vtmp2.m = ABS(y.v) > c.v
    tmp2 = vtmp2.m(0).and.vtmp2.m(2).and.vtmp.m(3).and.vtmp.m(3)
    if(tmp1.or.tmp2) then
 ...
 !DIR$ ATTRIBUTES ALIGN : 32 :: c,t
    ...
    isc = .true.
    vtmp1.m = ABS(x.v) > c.v
    tmp1 = vtmp1.m(0).and.vtmp1.m(1).and.vtmp1.m(2).and.vtmp1.m(3)
    vtmp2.m = ABS(y.v) > c.v
    tmp2 = vtmp2.m(0).and.vtmp2.m(1).and.vtmp2.m(2).and.vtmp2.m(3)
    if(tmp1.or.tmp2) then
  ...
  pure elemental function ymm8r4_cwt_ymm8r4(x,y,n,cutoff) result(isc)
    ...
    isc = .true.
    vtmp1.m = ABS(x.v) > c.v
    tmp1 = vtmp1.m(0).and.vtmp1.m(1).and.vtmp1.m(2).and.vtmp1.m(3).and.   &
         vtmp1.m(4).and.vtmp1.m(5).and.vtmp1.m(6).and.vtmp1.m(7)
    vtmp2.m = ABS(y.v) > c.v
    tmp2 =  vtmp2.m(0).and.vtmp2.m(1).and.vtmp2.m(2).and.vtmp2.m(3).and.   &
         vtmp2.m(4).and.vtmp2.m(5).and.vtmp2.m(6).and.vtmp2.m(7)
    if(tmp1.or.tmp2) then
  ...
  pure elemental function zmm16r4_cwt_zmm16r4(x,y,n,cutoff) result(isc)
    ...
    logical(kind=int4), automatic :: tmp1a,tmp1b,tmp2a,tmp2b
    ! Exec code ......
    if(present(cutoff)) then
       c = cutoff
    else
    ...
    isc = .true.
    vtmp1.m = ABS(x.v) > c.v
    tmp1a =  vtmp1.m(0).and.vtmp1.m(1).and.vtmp1.m(2).and.vtmp1.m(3).and.   &
         vtmp1.m(4).and.vtmp1.m(5).and.vtmp1.m(6).and.vtmp1.m(7)
    tmp1b = vtmp1.m(8).and.vtmp1.m(9).and.vtmp1.m(10).and.vtmp1.m(11) .and. &
         vtmp1.m(12).and.vtmp1.m(13).and.vtmp1.m(14).and.vtmp1.m(15)
    vtmp2.m = ABS(y.v) > c.v
    tmp2a =  vtmp2.m(0).and.vtmp2.m(1).and.vtmp2.m(2).and.vtmp2.m(3).and.   &
         vtmp2.m(4).and.vtmp2.m(5).and.vtmp2.m(6).and.vtmp2.m(7)
    tmp2b = vtmp2.m(8).and.vtmp2.m(9).and.vtmp2.m(10).and.vtmp2.m(11) .and. &
         vtmp2.m(12).and.vtmp2.m(13).and.vtmp2.m(14).and.vtmp2.m(15)
    tmp1a = tmp1a.and.tmp1b
    tmp2a = tmp2a.and.tmp2b
    if(tmp1a.or.tmp2a) then
