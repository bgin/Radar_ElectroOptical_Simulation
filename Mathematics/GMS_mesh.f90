...
module mod_mesh
 ...
 !=================================================================================
    ...
    type, public :: Mesh_dynamic_t
          ...
          integer(kind=int4)                                  :: ierror
          integer(kind=int4)                                  :: line_prune
          integer(kind=int4)                                  :: n_cor3   ! for OBJ
          integer(kind=int4)                                  :: n_face    ! for OBJ
          ...
          integer(kind=int4), dimension(:),    allocatable           :: cor3_material ! dim: n_cor3
          ...
          integer(kind=int4), dimension(:,:),  allocatable           :: edge          ! dim: 4,n_edge
          integer(kind=int4), dimension(:,:),  allocatable           :: face          ! for OBJ dim: n_order,n_face
                       
          real(kind=sp ),     dimension(:),    allocatable           :: face_area     ! for OBJ dim: n_face
          integer(kind=int4), dimension(:),    allocatable           :: face_material !         dim: n_face
          real(kind=sp),      dimension(:,:),  allocatable           :: face_normal  ! for OBJ  dim: 3,n_face
          integer(kind=int4), dimension(:),    allocatable           :: face_object  !          dim: n_face
          real(kind=sp),      dimension(:,:),  allocatable           :: face_point  ! for OBJ   dim: 3,n_face
          integer(kind=int4), dimension(:),    allocatable           :: face_order  !           dim: n_face
          integer(kind=int4), dimension(:),    allocatable           :: face_rank   !           dim: n_face
          real(kind=sp),      dimension(:,:),  allocatable           :: face_tex_uv !           dim: 2,n_face
          integer(kind=int4), dimension(:),    allocatable           :: face_tier   !           dim: n_face
          integer(kind=int4), dimension(:),    allocatable           :: line_dex    !           dim: n_line
          integer(kind=int4), dimension(:),    allocatable           :: line_material !         dim: n_line
          integer(kind=int4), dimension(:),    allocatable           :: list          !         dim: n_cor3
         
          real(kind=sp),      dimension(:,:),   allocatable          :: material_rgba !         dim: 4, n_material
          integer(kind=int4), dimension(:),     allocatable          :: point         !         dim: n_point
         
          real(kind=sp),      dimension(:,:),   allocatable          :: texture_temp  !         dim: 2,n_order*n_face
         
          integer(kind=int4), dimension(:,:),   allocatable          :: vertex_material  !      dim: n_order,n_face
