...
module avx_cvec4
 ...
 !==================================================================================85
    ...
    ! Tab:10,11 col - Type , function and subroutine code blocks.
     ...
     ! Module build date
     character(*),        parameter :: AVX_CVEC4_BUILD_DATE  = __DATE__ " " __TIME__
     ! Module author info
...
!DIR$ ATTRIBUTES INLINE :: c1_mul_ymm4c8
     pure function c1_mul_ymm4c8(lhs,rhs) result(iq)
       ...
       !DIR$ ATTRIBUTES ALIGN : 32 :: ymm0,ymm1,ymm2,ymm3
       type(YMM4r8_t) :: ymm0,ymm1,ymm2,ymm3
       ymm0.v = real(lhs,kind=dp)*rhs.re
       ymm1.v = aimag(lhs,kind=dp)*rhs.im
       iq.re  = ymm0.v+ymm1.v
       ymm2.v = real(lhs,kind=dp)*rhs.im
       ymm3.v = aimag(lhs,kind=dp)*rhs.re
       iq.im  = ymm2.v-ymm3.v
...
!DIR$ ATTRIBUTES INLINE :: ymm4c8_div_v4
     pure function ymm4c8_div_v4(lhs,rhs) result(iq)
       !DIR$ ATTRIBUTES CODE_ALIGN : 16 :: ymm4c8_div_v4
       !DIR$ ATTRIBUTES VECTOR :: ymm4c8_div_v4
       type(YMM4c8),  intent(in) :: lhs
       type(YMM4r8_t),       intent(in) :: rhs
       !DIR$ ATTRIBUTES ALIGN : 32 :: iq
       type(YMM4c8) :: iq
...
!DIR$ ATTRIBUTES INLINE :: v4_div_ymm4c8
     pure  function v4_div_ymm4c8(lhs,rhs) result(iq)
       !DIR$ ATTRIBUTES CODE_ALIGN : 16 :: v4_div_ymm4c8
       !DIR$ ATTRIBUTES VECTOR :: v4_div_ymm4c8
       type(YMM4r8_t),      intent(in) :: lhs
       type(YMM4c8), intent(in) :: rhs
       !DIR$ ATTRIBUTES ALIGN : 32 :: iq
       type(YMM4c8) :: iq
...
!DIR$ ATTRIBUTES INLINE :: ymm4c8_eq_c1
     pure function c8_eq_c1(lhs,rhs) result(bres)
