...
!  * Bernard Gingold, March 2025 : adding minor changes.
...
!  have been found in the case ```NPT=N+6``` even with more than 100 variables.
    ...
    subroutine bobyqa (n, npt, x, xl, xu, rhobeg, rhoend, iprint, maxfun, calfun)
        ...
        integer(i4),intent(in)                  :: n       !! number of variables (must be at least two)
        integer(i4),intent(in)                  :: npt     !! number of interpolation conditions. Its value must be in
        ...
        integer(i4),intent(in)                  :: iprint  !! IPRINT should be set to 0, 1, 2 or 3, which controls the
                                                       !! amount of printing. Specifically, there is no output if IPRINT=0 and
                                                       !! there is output only at the return if IPRINT=1. Otherwise, each new
                                                       !! value of RHO is printed, with the best vector of variables so far and
                                                       !! the corresponding value of the objective function. Further, each new
                                                       !! value of F with its variables are output if IPRINT=3.
        integer(i4),intent(in)                  :: maxfun  !! an upper bound on the number of calls of CALFUN.
        ...
        integer(i4) :: ibmat,id,ifv,igo,ihq,ipq,isl,isu,ivl,iw,ixa,&
...
!     The integer(i4) NTRITS is set to the number "trust region" iterations that
...
!       integer(i4) parts of PTSID(K) and (PTSID(K)-p) multiplied by N+1. If p
