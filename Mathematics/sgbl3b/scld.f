...
*  system.
*
*  The function SCLD returns .TRUE. if the leading dimension LD is
*  critical and .FALSE. if it is not critical. In this implementation
*  SCLD is designed to detect critical leading dimensions in an
...
*  It may be rewarding to rewrite SCLD for a machine with a different
*  cache policy.
*
...
*
*
*  User specified parameters for SCLD
*  ================================
*
...
*
      ...
      ELSE
         ...
         SCLD = MIN( UPDIF, LD-UPDIF ).LE.MXDIF
      END IF
*
      RETURN
*
