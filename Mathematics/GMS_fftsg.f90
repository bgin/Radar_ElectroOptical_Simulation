...
!====================================================================70
     subroutine ddct(n, isgn, a, ip, w)
      integer(i4) ::  n, isgn, ip(0 : *), j, nw, nc
...
!====================================================================70
    subroutine dfct(n, a, t, ip, w)
      integer(i4) :: n, ip(0 : *), j, k, l, m, mh, nw, nc
...
!====================================================================70
    subroutine makewt(nw, ip, w)
      integer(i4) :: nw, ip(0 : *), j, nwh, nw0, nw1
...
!====================================================================70
    subroutine makeipt(nw, ip)
      integer(i4) :: nw, ip(0 : *), j, l, m, m2, p, q
      ip(2) = 0
      ip(3) = 16
      m = 2
      l = nw
...
!====================================================================70
    subroutine bitrv2(n, ip, a)
      integer(i4) :: n, ip(0 : *), j, j1, k, k1, l, m, nh, nm
...
!====================================================================70
    subroutine cftf1st(n, a, w)
      integer(i4) :: n, j, j0, j1, j2, j3, k, m, mh
      real(dp)    :: a(0 : n - 1), w(0 : *)
...
!====================================================================70
    subroutine cftrec4(n, a, nw, w)
      integer(i4) :: n, nw, cfttree, isplt, j, k, m
      real(dp)    :: a(0 : n - 1), w(0 : nw - 1)
      m = n
      do while (m .gt. 512)
          m = m / 4
...
!====================================================================70
    subroutine cftmdl2(n, a, w)
      integer(i4) :: n, j, j0, j1, j2, j3, k, kr, m, mh
      real(dp)    :: a(0 : n - 1), w(0 : *)
