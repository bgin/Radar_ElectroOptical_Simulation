...
module mod_cheb_particles_common_AVX512
 ...
 !!==============================================================!!
     ...
     !=====================================================59
     integer(kind=int4), parameter :: MOD_CHEB_PARTICLES_COMMON_AVX512_MAJOR = 1
     integer(kind=int4), parameter :: MOD_CHEB_PARTICLES_COMMON_AVX512_MINOR = 0
     integer(kind=int4), parameter :: MOD_CHEB_PARTICLES_COMMON_AVX512_MICRO = 0
     integer(kind=int4), parameter :: MOD_CHEB_PARTICLES_COMMON_AVX512_FULLVER =    &
                                      1000*MOD_CHEB_PARTICLES_COMMON_AVX512_MAJOR + &
                                      100*MOD_CHEB_PARTICLES_COMMON_AVX512_MINOR  + &
                                      10*MOD_CHEB_PARTICLES_COMMON_AVX512_MICRO
     character(*),       parameter :: MOD_CHEB_PARTICLES_COMMON_AVX512_CREATE_DATE = "21-01-2020 10:12 AM +00200 (TUE 21 JAN 2020 GMT+2)"
     character(*),       parameter :: MOD_CHEB_PARTICLES_COMMON_AVX512_BUILD_DATE  = __DATE__ " " __TIME__
     character(*),       parameter :: MOD_CHEB_PARTICLES_COMMON_AVX512_AUTHOR      = "Programmer: Bernard Gingold, contact: beniekg@gmail.com"
     character(*),       parameter :: MOD_CHEB_PARTICLES_COMMON_AVX512_DESCRIPT    = "Subroutines which are common for Chebyshev particles shape computation (AVX512)."
     ! Constants
...
end module mod_cheb_particles_common_AVX512
