 ...
 ! Tab:10,11 col - Type , function and subroutine code blocks.
    ...
    !====================================
      ...
      type, public :: Quaternion_t
        ...
        procedure, nopass, public :: read_file
        
        procedure, nopass, public :: write_file
    ...
    subroutine complex_init(this,c1,c2)
          ...
          this.m_q.v(1) = AIMAG(c1)
          this.m_q.v(2) = REAL(c2,KIND=dp)
          this.m_q.v(3) = AIMAG(c2)
    end subroutine
    ...
    !            read/write
    !=================================================! 
    subroutine read_file(this,filename,iounit,ioerr)
          ...
          if(ioerr > 0) return
          read(iounit,'(4F22.15)',IOSTAT=ioerr) this.m_q.v(0),this.m_q.v(1),this.m_q.v(2),this.m_q.v(3)
          if(ioerr > 0 .or. ioerr < 0) return
    end subroutine
    ...
    !            read/write
    !=================================================! 
    subroutine write_file(this,filename,iounit,ioerr)
          ...
          if(ioerr > 0) return
          write(iounit,'(4F22.15)',IOSTAT=ioerr) this.m_q.v(0),this.m_q.v(1),this.m_q.v(2),this.m_q.v(3)
          if(ioerr > 0 .or. ioerr < 0) return
    end subroutine
...
!DIR$     ATTRIBUTES ALIGN : 64 :: m4x4
          real(kind=dp), dimension(0:3,0:3) :: m4x4
...
!DIR$     ATTRIBUTES ALIGN : 64 :: v
  ...
  ! @attributes: 
  !=============================================
  pure function q_add_q(lhs,rhs) result(nq)
          implicit none
...
!DIR$     ATTRIBUTES ALIGN : 64 :: nq
          type(Quaternion_t) :: nq
          ! Start of executable statements
          nq.m_q.v(0) = lhs.m_q.v(0) + REAL(rhs)
          nq.m_q.v(1) = lhs.m_q.v(1) + AIMAG(rhs)
          nq.m_q.v(2) = lhs.m_q.v(2) + REAL(rhs)
          nq.m_q.v(3) = lhs.m_q.v(3) + AIMAG(rhs)
  end function
...
!DIR$     ATTRIBUTES ALIGN : 64 :: nq
          type(Quaternion_t) :: nq
          ! Start of executable statements
          nq.m_q.v(0) = REAL(lhs)  + rhs.m_q.v(0)
          nq.m_q.v(1) = AIMAG(lhs) + rhs.m_q.v(1)
          nq.m_q.v(2) = REAL(lhs)  + rhs.m_q.v(2)
          nq.m_q.v(3) = AIMAG(lhs) + rhs.m_q.v(3)
  end function
...
!DIR$     ATTRIBUTES ALIGN : 64 :: nq
          type(Quaternion_t) :: nq
          ! Start of executable statements
          nq.m_q.v(0) = q.m_q.v(0) * REAL(c)
          nq.m_q.v(1) = q.m_q.v(1) * AIMAG(c)
          nq.m_q.v(2) = q.m_q.v(2) * REAL(c)
          nq.m_q.v(3) = q.m_q.v(3) * AIMAG(c)
  end function
...
!DIR$     ATTRIBUTES ALIGN : 64 :: nq
          type(Quaternion_t) :: nq
          ! Start of executable statemetns
          nq.m_q.v(0) = REAL(c) - q.m_q.v(0)
          nq.m_q.v(1) = AIMAG(c) - q.m_q.v(1)
          nq.m_q.v(2) = REAL(c)  - q.m_q.v(2)
          nq.m_q.v(3) = AIMAG(c) - q.m_q.v(3)
  end function
...
!DIR$     ATTRIBUTES ALIGN : 64 :: nq
          ...
          denom = re*re+im*im
          ivdenom = 1.0_dp/denom
          nq.m_q.v(0) = (re*q.m_q.v(0)+im*q.m_q.v(1))*ivdenom
          nq.m_q.v(1) = (im*(-q.m_q.v(0))+re*q.m_q.v(1))*ivdenom
          nq.m_q.v(2) = (re*q.m_q.v(2)-im*q.m_q.v(3))*ivdenom
          nq.m_q.v(3) = (im*q.m_q.v(2)+re*q.m_q.v(3))*ivdenom
  end function
...
!DIR$     ATTRIBUTES ALIGN : 64 :: nq
  ...
  ! @attributes: 
  !============================================= 
  pure function q_idotp_q(q1,q2) result(d)
          
          type(Quaternion_t), intent(in) :: q1,q2
          ! Locals
          real(kind=dp) :: d
          ! Start of executable statements
          d = q1.m_q.v(1)*q2.m_q.v(1)+q1.m_q.v(2)*q2.m_q.v(2)+ &
               q1.m_q.v(3)*q2.m_q.v(3)
  end function
...
!DIR$     ATTRIBUTES ALIGN : 64 :: cp
          ...
          cp.m_q.v(0) = 0.0_dp
          cp.m_q.v(1) = q1.m_q.v(2)*q2.m_q.v(3)-q1.m_q.v(3)*q2.m_q.v(2)
          cp.m_q.v(2) = q1.m_q.v(3)*q2.m_q.v(1)-q1.m_q.v(1)*q2.m_q.v(3)
          cp.m_q.v(3) = q1.m_q.v(1)*q2.m_q.v(2)-q1.m_q.v(2)*q2.m_q.v(1)
  end function
