...
!-------------------------------------------------------------
            if(supsat.gt.0.and.ifsat.ne.1) then
              ...
              roqi0 = 4.92e-11_sp*xni0**1.33_sp
...
!     padding for small values
  ...
  !--------------------------------------------------------------------------
   ...
   subroutine slope_wsm6(qrs,den,denfac,t,rslope,rslopeb,rslope2,rslope3,   &
        ...
        !dir$ attributes optimization_parameter: "TARGET_ARCH=SKYLAKE-AVX512" :: slope_wsm6
...
!-----------------------------------------------------------------------------
      ...
      subroutine slope_rain(qrs,den,denfac,t,rslope,rslopeb,rslope2,rslope3,   & 
        ...
        !dir$ attributes optimization_parameter: "TARGET_ARCH=SKYLAKE-AVX512" :: slope_rain
...
!     valid for mixing ratio > 1.e-9 kg/kg.
  ...
  !------------------------------------------------------------------------------
      ...
      subroutine slope_snow(qrs,den,denfac,t,rslope,rslopeb,rslope2,rslope3, &
       ...
       !dir$ optimize : 3
       !dir$ attributes optimization_parameter:"TARGET_ARCH=SKYLAKE-AVX512" :: slope_snow
  ...
  !----------------------------------------------------------------------------------
      ...
      subroutine slope_graup(qrs,den,denfac,t,rslope,rslopeb,rslope2,rslope3, &
        ...
        !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: slope_graup
         !dir$ attributes optimization_parameter:"TARGET_ARCH=SKYLAKE-AVX512" :: slope_graup
...
!---------------------------------------------------------------------------------
  ...
  SUBROUTINE nislfv_rain_plm(its,ite,kts,kte,denl,denfacl,tkl,dzl,wwl,rql,precip,dt,id,iter)
    ...
    !dir$ attributes optimization_parameter:"TARGET_ARCH=SKYLAKE-AVX512" :: nislfv_rain_plm
...
!
   ...
   SUBROUTINE nislfv_rain_plm6(its,ite,kts,kte,denl,denfacl,tkl,dzl,wwl,rql,rql2, &
     ...
     !dir$ optimize : 3
     !dir$ attributes optimization_parameter:"TARGET_ARCH=SKYLAKE-AVX512" :: nislfv_rain_plm6
