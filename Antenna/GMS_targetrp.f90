...
module mod_targetrp
 ...
 !=================================================================================
    ...
    ! Major version
    integer(kind=i4), parameter, public :: MOD_TARGETRP_MAJOR = 1
    
    ! Minor version
    integer(kind=i4), parameter, public :: MOD_TARGETRP_MINOR = 0
    
    ! Micro version
    integer(kind=i4), parameter, public :: MOD_TARGETRP_MICRO = 0
    
    ! Module full version
    integer(kind=i4), parameter, public :: MOD_TARGETRP_FULLVER = 1000*MOD_TARGETRP_MAJOR + &
                                                                    100*MOD_TARGETRP_MINOR  + &
                                                                    10*MOD_TARGETRP_MINOR
