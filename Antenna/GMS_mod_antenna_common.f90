...
!==================================================================================85
    ...
    ! Major version
    integer(kind=i4),  parameter :: MOD_ANTENNA_COMMON_MAJOR = 1
    ! Minor version
    integer(kind=i4),  parameter :: MOD_ANTENNA_COMMON_MINOR = 0
    ! Micro version
    integer(kind=i4),  parameter :: MOD_ANTENNA_COMMON_MICRO = 0
    ! Full version
    integer(kind=i4),  parameter :: MOD_ANTENNA_COMMON_FULLVER =   &
            1000*MOD_ANTENNA_COMMON_MAJOR+100*MOD_ANTENNA_COMMON_MINOR+10*MOD_ANTENNA_COMMON_MICRO
    ! Module creation date
    character(*),        parameter :: MOD_ANTENNA_COMMON_CREATE_DATE = "18-11-2023 09:53 +00200 (SAT 18 NOV 20223 GMT+2)"
    ! Module build date
    character(*),        parameter :: MOD_ANTENNA_COMMON_BUILD_DATE  = __DATE__ " " __TIME__
    ! Module author info
    character(*),        parameter :: MOD_ANTENNA_COMMON_AUTHOR      = "Programmer: Bernard Gingold, contact: beniekg@gmail.com"
    ! Short description
    character(*),        parameter :: MOD_ANTENNA_COMMON_SYNOPSIS    = "Data describing various common antenna characteristics -- module based."
