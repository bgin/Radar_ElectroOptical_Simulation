...
module mod_segdataout
 ...
 !=================================================================================
    ...
    ! Major version
    integer(kind=i4), parameter, public :: MOD_SEGDATAOUT_MAJOR = 1_int4
    
    ! Minor version
    integer(kind=i4), parameter, public :: MOD_SEGDATAOUT_MINOR = 0_int4
    
    ! Micro version
    integer(kind=i4), parameter, public :: MOD_SEGDATAOUT_MICRO = 0_int4
    
    ! Module full version
    integer(kind=i4), parameter, public :: MOD_SEGDATAOUT_FULLVER = 1000_int4*MOD_SEGDATAOUT_MAJOR+100_int4*MOD_SEGDATAOUT_MINOR+ &
...
#define GMS_SEGDATAOUT_ADD_PADDING 1
    ...
    type, public :: NECWireDataOut_t
          ...
          integer(kind=i1), dimension(0:3) :: pad
#endif
          ! Wire number
#if defined __INTEL_COMPILER
          !DIR$     ATTRIBUTES ALIGN : 64 :: m_wirenum
#endif
          integer(kind=i4), allocatable, dimension(:) :: m_wirenum
          ! X1 coordinate
#if defined __INTEL_COMPILER
...
#endif
          integer(kind=i4), allocatable, dimension(:) :: m_firstseg
          ! Last segment value (interval in number of segments per wire)
#if defined __INTEL_COMPILER
          !DIR$     ATTRIBUTES ALIGN : 64 :: m_lastseg
#endif
          integer(kind=i4), allocatable, dimension(:) :: m_lastseg
          ! Tag number
#if defined __INTEL_COMPILER
...
#endif
          integer(kind=i4),   allocatable, dimension(:) :: m_Iminus
          ! I    -- CONNECTION DATA
#if defined __INTEL_COMPILER
          !DIR$     ATTRIBUTES ALIGN : 64 :: m_I
#endif
          integer(kind=i4),   allocatable, dimension(:) :: m_I
          ! I+   -- CONNECTION DATA
#if defined __INTEL_COMPILER
          !DIR$     ATTRIBUTES ALIGN : 64 :: m_Iplus
#endif
          integer(kind=i4),   allocatable, dimension(:) :: m_Iplus
          ! Tag number
#if defined __INTEL_COMPILER
          !DIR$     ATTRIBUTES ALIGN : 64 :: m_tagnum
#endif
...
9999      call handle_fatal_memory_error( iounit,logging,verbose,append,fname,                                                    &
    ...
    subroutine readNECWireDataOut(wirenum,x1,y1,z1,x2,y2,z2,   &
      ...
      !DIR$ ATTRIBUTES ALIGN : 32 :: readNECWireDataOut
          ...
          integer(kind=i4), contiguous,dimension(:),  intent(out)   :: wirenum
          ...
          integer(kind=i4), contiguous,dimension(:),  intent(out)   :: msegs
          integer(kind=i4), contiguous,dimension(:),  intent(out)   :: firstseg
          integer(kind=i4), contiguous,dimension(:),  intent(out)   :: lastseg
          integer(kind=i4), contiguous,dimension(:),  intent(out)   :: tagnum
          integer(kind=i4),                           intent(in)    :: ncols
          integer(kind=i4),                           intent(in)    :: iounit
...
9999      call handle_fatal_memory_error( iounit, logging,verbose,append,fname, &
    ...
    subroutine readNECSegmentDataOut(segnum,xcoord,ycoord,zcoord,       &
      ...
      !DIR$ ATTRIBUTES CODE_ALIGN : 32 :: readNECSegmentDataOut
#endif
          use mod_print_error,  only : handle_fatal_fileio_error
          integer(kind=i4), contiguous,dimension(:), intent(out) :: segnum
          ...
          integer(kind=i4), contiguous,dimension(:), intent(out) :: Iminus
          integer(kind=i4), contiguous,dimension(:), intent(out) :: I
          integer(kind=i4), contiguous,dimension(:), intent(out) :: Iplus
          integer(kind=i4), contiguous,dimension(:), intent(out) :: tagnum
          integer(kind=i4),                          intent(in)  :: ncols
          integer(kind=i4),                          intent(in)    :: iounit
          character(len=*),                            intent(in)    :: filename
