...
!DIR$     ATTRIBUTES ALIGN : 64 :: m_radii
    ...
    subroutine initNECGWires(wf,ncols,errstate,logging,verbose,append,fname)
...
9999      call handle_fatal_memory_error( logging,verbose,append,fname,                                                    &
    ...
    subroutine readNECGWires(wf,iounit,filename,errmsg,ioerr,logging,verbose,append,fname)
