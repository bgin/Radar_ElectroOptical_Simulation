...
module avx_cvec8
 ...
 !==================================================================================85
    ...
    ! Tab:10,11 col - Type , function and subroutine code blocks.
     ...
     ! Major version
     integer(kind=i4),  parameter :: AVX_CVEC8_MAJOR = 1
     ! Minor version
     integer(kind=i4),  parameter :: AVX_CVEC8_MINOR = 0
     ! Micro version
     integer(kind=i4),  parameter :: AVX_CVEC8_MICRO = 0
     ! Full version
     integer(kind=i4),  parameter :: AVX_CVEC8_FULLVER =   &
            1000*AVX_CVEC8_MAJOR+100*AVX_CVEC8_MINOR+10*AVX_CVEC8_MICRO
     ! Module creation date
     character(*),        parameter :: AVX_CVEC8_CREATE_DATE = "20-12-2021 15:54 +00200 (MON 20 DEC 2021 GMT+2)"
     ! Module build date
     character(*),        parameter :: AVX_CVEC8_BUILD_DATE  = __DATE__ 

     character(*),        parameter :: AVX_CVEC8_BUILD_TIME  = __TIME__
     ! Module author info
...
!DIR$ ATTRIBUTES INLINE :: ymm8c4_add_ymm8r4
     pure function ymm8c4_add_ymm8r4(lhs,rhs) result(iq)
       ...
       iq.re = lhs.re+rhs.v
       iq.im = lhs.im
     end function ymm8c4_add_ymm8r4
...
!DIR$ ATTRIBUTES INLINE :: ymm8c4_le_c1
     pure function ymm8c4_le_c1(lhs,rhs) result(bres)
...
!DIR$ ATTRIBUTES INLINE :: carg_2xymm8r4     
     pure function carg_2xymm8r4(re,im) result(arg)
       ...
       !DIR$ ATTRIBUTES VECTOR :: carg_2xymm8r4
...
!DIR$ ATTRIBUTES INLINE :: csqrt_ymm8c4
      pure function csqrt_ymm8c4(c8) result(iq)
        ...
        ! Exec code ....
        t0 = cabs_ymm8c4(c8)
        t1.v = v8r4_half.v*(t0.v+c8.re)
        iq.re = sqrt(t1.v)
        t2.v = v8r4_half.v*(t0.v-c8.re)
        iq.im = sqrt(t2.v)
...
!DIR$ ATTRIBUTES INLINE :: csqrt_2xymm8r4
      pure function csqrt_2xymm8r4(re,im) result(iq)
        ...
        ! Exec code ....
        t0 = cabs_2xymm8r4(re,im)
        t1.v = v8r4_half.v*(t0.v+re.v)
        iq.re = sqrt(t1.v)
        t2.v = v8r4_half.v*(t0.v-re.v)
