...
!==================================================================================85
   ...
   implicit none
     ...
     ! Major version
     integer(kind=i4),  parameter :: EOS_SENSOR_AVX_MAJOR = 1
     ! Minor version
     integer(kind=i4),  parameter :: EOS_SENSOR_AVX_MINOR = 0
     ! Micro version
     integer(kind=i4),  parameter :: EOS_SENSOR_AVX_MICRO = 0
     ! Full version
     integer(kind=i4),  parameter :: EOS_SENSOR_AVX_FULLVER =   &
            1000*EOS_SENSOR_AVX_MAJOR+100*EOS_SENSOR_AVX_MINOR+10*EOS_SENSOR_AVX_MICRO
     ! Module creation date
     character(*),        parameter :: EOS_SENSOR_AVX_CREATE_DATE = "24-08-2022 17:17 +00200 (WED 24 AUG 2022 GMT+2)"
     ! Module build date
     character(*),        parameter :: EOS_SENSOR_AVX_BUILD_DATE  = __DATE__ " " __TIME__
     ! Module author info
     character(*),        parameter :: EOS_SENSOR_AVX_AUTHOR      = "Programmer: Bernard Gingold, contact: beniekg@gmail.com"
     ! Short description
     character(*),        parameter :: EOS_SENSOR_AVX_SYNOPSIS    = "EO Sensors characteristics and models explicitly vectorized (AVX)."
...
!/////////////////////////////////////////////////////////////////////////////////!
    ...
    subroutine defocus_cof_unroll_16x_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_16x_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_unroll_16x_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_16x_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
        type(YMM8r4_t), dimension(1:n), intent(out):: dc
        integer(kind=i4),                intent(in) :: n
        ...
        if(m /= 0) then
           do i=1,m
              a0     =  alpha(i)
              dc(i)  =  defocus_cof_ymm8r4(l2,a0,O,inf)
           end do
           if(n<16) return
        end if
        m1 = m+1
        ...
        do i=m1,n,16
            ...
            dc(i)   =  defocus_cof_ymm8r4(l2,a0,O,inf)
            a1      =  alpha(i+1)
            dc(i+1) =  defocus_cof_ymm8r4(l2,a1,O,inf)
            a2      =  alpha(i+2)
            dc(i+2) =  defocus_cof_ymm8r4(l2,a2,O,inf)
            a3      =  alpha(i+3)
            dc(i+3) =  defocus_cof_ymm8r4(l2,a3,O,inf)
            a4      =  alpha(i+4)
            dc(i+4) =  defocus_cof_ymm8r4(l2,a4,O,inf)
            a5      =  alpha(i+5)
            dc(i+5) =  defocus_cof_ymm8r4(l2,a5,O,inf)
            a6      =  alpha(i+6)
            dc(i+6) =  defocus_cof_ymm8r4(l2,a6,O,inf)
            a7      =  alpha(i+7)
            dc(i+7) =  defocus_cof_ymm8r4(l2,a7,O,inf)
            a8      =  alpha(i+8)
            dc(i+8) =  defocus_cof_ymm8r4(l2,a8,O,inf)
            a9      =  alpha(i+9)
            dc(i+9) =  defocus_cof_ymm8r4(l2,a9,O,inf)
            a10     =  alpha(i+10)
            dc(i+10)=  defocus_cof_ymm8r4(l2,a10,O,inf)
            a11     =  alpha(i+11)
            dc(i+11)=  defocus_cof_ymm8r4(l2,a11,O,inf)
            a12     =  alpha(i+12)
            dc(i+12)=  defocus_cof_ymm8r4(l2,a12,O,inf)
            a13     =  alpha(i+13)
            dc(i+13)=  defocus_cof_ymm8r4(l2,a13,O,inf)
            a14      =  alpha(i+1)
            dc(i+14) =  defocus_cof_ymm8r4(l2,a14,O,inf) 
            a15      =  alpha(i+15)
            dc(i+15) =  defocus_cof_ymm8r4(l2,a15,O,inf) 
        end do
    end subroutine defocus_cof_unroll_16x_ymm8r4


    subroutine defocus_cof_unroll_16x_omp_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_16x_omp_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_unroll_16x_omp_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_16x_omp_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    subroutine defocus_cof_unroll_8x_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_8x_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_unroll_8x_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_8x_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    end subroutine defocus_cof_unroll_8x_ymm8r4


    subroutine defocus_cof_unroll_8x_omp_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_8x_omp_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_unroll_8x_omp_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_8x_omp_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
     ...
     subroutine defocus_cof_unroll_4x_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_4x_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_unroll_4x_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_4x_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    end subroutine defocus_cof_unroll_4x_ymm8r4


    subroutine defocus_cof_unroll_4x_omp_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_4x_omp_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_unroll_4x_omp_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_4x_omp_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    subroutine defocus_cof_unroll_2x_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_2x_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_unroll_2x_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_2x_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    end subroutine defocus_cof_unroll_2x_ymm8r4


    


    subroutine defocus_cof_unroll_2x_omp_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_2x_omp_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_unroll_2x_omp_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_2x_omp_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    subroutine defocus_cof_rolled_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_rolled_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_rolled_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_rolled_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    end subroutine defocus_cof_rolled_ymm8r4


    subroutine defocus_cof_rolled_omp_ymm8r4(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_rolled_omp_ymm8r4
        !dir$ attributes forceinline :: defocus_cof_rolled_omp_ymm8r4
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_rolled_omp_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    subroutine defocus_cof_dispatch_ymm8r4(l2,alpha,O,inf,dc,n,unroll_cnt,omp_ver)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_dispatch_ymm8r4
        type(YMM8r4_t),                 intent(in) :: l2
        type(YMM8r4_t), dimension(1:n), intent(in) :: alpha
        type(YMM8r4_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
        ...
        if(omp_ver) then
           select case (unroll_cnt)
               ...
               case (4)
                  call defocus_cof_unroll_4x_omp_ymm8r4(l2,alpha,O,inf,dc,n)
               case (2)
    ...
    end subroutine defocus_cof_dispatch_ymm8r4
    ...
    subroutine defocus_cof_unroll_16x_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_16x_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_unroll_16x_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_16x_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
        type(YMM4r8_t), dimension(1:n), intent(out):: dc
        integer(kind=i4),                intent(in) :: n
        ...
        if(m /= 0) then
           do i=1,m
              a0     =  alpha(i)
              dc(i)  =  defocus_cof_ymm4r8(l2,a0,O,inf)
           end do
           if(n<16) return
        end if
        m1 = m+1
        ...
        do i=m1,n,16
            ...
            dc(i)   =  defocus_cof_ymm4r8(l2,a0,O,inf)
            a1      =  alpha(i+1)
            dc(i+1) =  defocus_cof_ymm4r8(l2,a1,O,inf)
            a2      =  alpha(i+2)
            dc(i+2) =  defocus_cof_ymm4r8(l2,a2,O,inf)
            a3      =  alpha(i+3)
            dc(i+3) =  defocus_cof_ymm4r8(l2,a3,O,inf)
            a4      =  alpha(i+4)
            dc(i+4) =  defocus_cof_ymm4r8(l2,a4,O,inf)
            a5      =  alpha(i+5)
            dc(i+5) =  defocus_cof_ymm4r8(l2,a5,O,inf)
            a6      =  alpha(i+6)
            dc(i+6) =  defocus_cof_ymm4r8(l2,a6,O,inf)
            a7      =  alpha(i+7)
            dc(i+7) =  defocus_cof_ymm4r8(l2,a7,O,inf)
            a8      =  alpha(i+8)
            dc(i+8) =  defocus_cof_ymm4r8(l2,a8,O,inf)
            a9      =  alpha(i+9)
            dc(i+9) =  defocus_cof_ymm4r8(l2,a9,O,inf)
            a10     =  alpha(i+10)
            dc(i+10)=  defocus_cof_ymm4r8(l2,a10,O,inf)
            a11     =  alpha(i+11)
            dc(i+11)=  defocus_cof_ymm4r8(l2,a11,O,inf)
            a12     =  alpha(i+12)
            dc(i+12)=  defocus_cof_ymm4r8(l2,a12,O,inf)
            a13     =  alpha(i+13)
            dc(i+13)=  defocus_cof_ymm4r8(l2,a13,O,inf)
            a14      =  alpha(i+1)
            dc(i+14) =  defocus_cof_ymm4r8(l2,a14,O,inf) 
            a15      =  alpha(i+15)
            dc(i+15) =  defocus_cof_ymm4r8(l2,a15,O,inf) 
        end do
    end subroutine defocus_cof_unroll_16x_ymm4r8


    subroutine defocus_cof_unroll_16x_omp_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_16x_omp_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_unroll_16x_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_16x_omp_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    subroutine defocus_cof_unroll_8x_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_8x_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_unroll_8x_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_8x_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    end subroutine defocus_cof_unroll_8x_ymm4r8


    subroutine defocus_cof_unroll_8x_omp_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_8x_omp_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_unroll_8x_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_8x_omp_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
     ...
     subroutine defocus_cof_unroll_4x_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_4x_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_unroll_4x_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_4x_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    end subroutine defocus_cof_unroll_4x_ymm4r8


    subroutine defocus_cof_unroll_4x_omp_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_4x_omp_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_unroll_4x_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_4x_omp_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    subroutine defocus_cof_unroll_2x_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_2x_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_unroll_2x_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_2x_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    end subroutine defocus_cof_unroll_2x_ymm4r8


    


    subroutine defocus_cof_unroll_2x_omp_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_unroll_2x_omp_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_unroll_2x_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_unroll_2x_omp_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    subroutine defocus_cof_rolled_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_rolled_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_rolled_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_rolled_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    end subroutine defocus_cof_rolled_ymm4r8


    subroutine defocus_cof_rolled_omp_ymm4r8(l2,alpha,O,inf,dc,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_rolled_omp_ymm4r8
        !dir$ attributes forceinline :: defocus_cof_rolled_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: defocus_cof_rolled_omp_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
    ...
    subroutine defocus_cof_dispatch_ymm4r8(l2,alpha,O,inf,dc,n,unroll_cnt,omp_ver)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: defocus_cof_dispatch_ymm4r8
        type(YMM4r8_t),                 intent(in) :: l2
        type(YMM4r8_t), dimension(1:n), intent(in) :: alpha
        type(YMM4r8_t),                 intent(in) :: O
        logical(kind=i4),                intent(in) :: inf
        ...
        if(omp_ver) then
           select case (unroll_cnt)
               ...
               case (4)
                  call defocus_cof_unroll_4x_omp_ymm4r8(l2,alpha,O,inf,dc,n)
               case (2)
    ...
    end subroutine defocus_cof_dispatch_ymm4r8
    ...
    pure function circle_dispersion_ymm4r8(d,l1,l2,alpha,O,inf) result(rho)
     ...
     subroutine circle_dispersion_unroll_16x_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_unroll_16x_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_unroll_16x_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_unroll_16x_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
        type(YMM4r8_t),                   intent(in) :: O
        logical(kind=i4),                  intent(in) :: inf
        type(YMM4r8_t), dimension(1:n),   intent(in) :: rho
        integer(kind=i4),                  intent(in) :: n
        type(YMM4r8_t), automatic :: a0,a1,a2,a3,a4,a5,a6,a7
        type(YMM4r8_t), automatic :: a8,a9,a10,a11,a12,a13,a14,a15
        !dir$ attributes align : 32 :: a0,a1,a2,a3,a4,a5,a6,a7
        ...
        if(m /= 0) then
           do i=1,m
              a0       = alpha(i)
              rho(i)   = circle_dispersion_ymm4r8(d,l1,l2,a0,O,inf)
           end do
           if(n<16) return
        end if
        m1 = m+1
        ...
        do i=m1,n,16
             ...
             rho(i)    = circle_dispersion_ymm4r8(d,l1,l2,a0,O,inf)
             a1        = alpha(i+1)
             rho(i+1)  = circle_dispersion_ymm4r8(d,l1,l2,a1,O,inf)
             a2        = alpha(i+2)
             rho(i+2)  = circle_dispersion_ymm4r8(d,l1,l2,a2,O,inf)
             a3        = alpha(i+3)
             rho(i+3)  = circle_dispersion_ymm4r8(d,l1,l2,a3,O,inf)
             a4        = alpha(i+1)
             rho(i+4)  = circle_dispersion_ymm4r8(d,l1,l2,a4,O,inf)
             a5        = alpha(i+5)
             rho(i+5)  = circle_dispersion_ymm4r8(d,l1,l2,a5,O,inf)
             a6        = alpha(i+6)
             rho(i+6)  = circle_dispersion_ymm4r8(d,l1,l2,a6,O,inf)
             a7        = alpha(i+7)
             rho(i+7)  = circle_dispersion_ymm4r8(d,l1,l2,a7,O,inf)
             a8        = alpha(i+8)
             rho(i+8)  = circle_dispersion_ymm4r8(d,l1,l2,a8,O,inf)  
             a9        = alpha(i+9)
             rho(i+9)  = circle_dispersion_ymm4r8(d,l1,l2,a9,O,inf)
             a10       = alpha(i+10)
             rho(i+10) = circle_dispersion_ymm4r8(d,l1,l2,a10,O,inf)
             a11       = alpha(i+1)
             rho(i+11) = circle_dispersion_ymm4r8(d,l1,l2,a11,O,inf)
             a12       = alpha(i+12)
             rho(i+12) = circle_dispersion_ymm4r8(d,l1,l2,a12,O,inf)
             a13       = alpha(i+13)
             rho(i+13) = circle_dispersion_ymm4r8(d,l1,l2,a13,O,inf)
             a14       = alpha(i+14)
             rho(i+14) = circle_dispersion_ymm4r8(d,l1,l2,a14,O,inf) 
             a15       = alpha(i+15)
             rho(i+15) = circle_dispersion_ymm4r8(d,l1,l2,a15,O,inf)
         end do
    end subroutine circle_dispersion_unroll_16x_ymm4r8


    subroutine circle_dispersion_unroll_16x_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_unroll_16x_omp_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_unroll_16x_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_unroll_16x_omp_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
        ...
        do i=m1,n,16
         ...
         !$omp end parallel do
    end subroutine circle_dispersion_unroll_16x_omp_ymm4r8


    subroutine circle_dispersion_unroll_8x_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_unroll_8x_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_unroll_8x_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_unroll_8x_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
    ...
    end subroutine circle_dispersion_unroll_8x_ymm4r8


    subroutine circle_dispersion_unroll_8x_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_unroll_8x_omp_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_unroll_8x_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_unroll_8x_omp_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
        ...
        do i=m1,n,8
         ...
         !$omp end parallel do
    end subroutine circle_dispersion_unroll_8x_omp_ymm4r8


    subroutine circle_dispersion_unroll_4x_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_unroll_4x_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_unroll_4x_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_unroll_4x_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
    ...
    end subroutine circle_dispersion_unroll_4x_ymm4r8


    subroutine circle_dispersion_unroll_4x_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_unroll_4x_omp_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_unroll_4x_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_unroll_4x_omp_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
        ...
        do i=m1,n,4
         ...
         !$omp end parallel do
    end subroutine circle_dispersion_unroll_4x_omp_ymm4r8


    subroutine circle_dispersion_unroll_2x_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_unroll_2x_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_unroll_2x_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_unroll_2x_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
    ...
    end subroutine circle_dispersion_unroll_2x_ymm4r8


    subroutine circle_dispersion_unroll_2x_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_unroll_2x_omp_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_unroll_2x_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_unroll_2x_omp_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
        ...
        !$omp end parallel do
    end subroutine circle_dispersion_unroll_2x_omp_ymm4r8


    
    subroutine circle_dispersion_rolled_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_rolled_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_rolled_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_rolled_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
    ...
    end subroutine circle_dispersion_rolled_ymm4r8


    subroutine circle_dispersion_rolled_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_rolled_omp_ymm4r8
        !dir$ attributes forceinline :: circle_dispersion_rolled_omp_ymm4r8
        !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circle_dispersion_rolled_omp_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        type(YMM4r8_t),                   intent(in) :: l1
        type(YMM4r8_t),                   intent(in) :: l2
        type(YMM4r8_t), dimension(1:n),   intent(in) :: alpha
        ...
        !$omp end parallel do
    end subroutine circle_dispersion_rolled_omp_ymm4r8



    subroutine circle_dispersion_dispatch_ymm4r8(d,l1,l2,alpha,O,inf,rho,n,unroll_cnt,omp_ver)
        !dir$ optimize:3
        !dir$ attributes code_align : 32 :: circle_dispersion_dispatch_ymm4r8
        type(YMM4r8_t),                   intent(in) :: d
        ...
        if(omp_ver) then
           select case (unroll_cnt)
               case (16)
                  call circle_dispersion_unroll_16x_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case (8)
                  call circle_dispersion_unroll_8x_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case (4)
                  call circle_dispersion_unroll_4x_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case (2)
                  call circle_dispersion_unroll_2x_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case (0)
                  call circle_dispersion_rolled_omp_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case default
                  return
            end select
         else
            select case (unroll_cnt)
               case (16)
                  call circle_dispersion_unroll_16x_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case (8)
                  call circle_dispersion_unroll_8x_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case (4)
                  call circle_dispersion_unroll_4x_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case (2)
                  call circle_dispersion_unroll_2x_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case (0)
                  call circle_dispersion_rolled_ymm4r8(d,l1,l2,alpha,O,inf,rho,n)
               case default
                  return
            end select
         end if
    end subroutine circle_dispersion_dispatch_ymm4r8
     ...
     subroutine circ_dispers_diam_unroll_16x_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_16x_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_16x_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_16x_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
         logical(kind=i4),                    intent(in) :: inf
         type(YMM8r4_t),    dimension(1:n),  intent(out):: ratio
         integer(kind=i4),                    intent(in) :: n
         type(YMM8r4_t), automatic :: a0,a1,a2,a3,a4,a5,a6,a7
         type(YMM8r4_t), automatic :: a8,a9,a10,a11,a12,a13,a14,a15
         !dir$ attributes align : 32 :: a0,a1,a2,a3,a4,a5,a6,a7
         ...
         if(m /= 0) then
            do i=1,m
               a0   = alpha(i)
               ratio(i) = circ_dispers_diam_ymm8r4(l1,l2,a0,O,inf)
            end do
            if(n<16) return
         end if
         m1 = m+1
         ...
         do i=m1,n,16
             ...
             ratio(i)   = circ_dispers_diam_ymm8r4(l1,l2,a0,O,inf)
             a1         = alpha(i+1)
             ratio(i+1) = circ_dispers_diam_ymm8r4(l1,l2,a1,O,inf)
             a2         = alpha(i+2)
             ratio(i+2) = circ_dispers_diam_ymm8r4(l1,l2,a2,O,inf)
             a3         = alpha(i+3)
             ratio(i+3) = circ_dispers_diam_ymm8r4(l1,l2,a3,O,inf)
             a4         = alpha(i+4)
             ratio(i+4) = circ_dispers_diam_ymm8r4(l1,l2,a4,O,inf)
             a5         = alpha(i+5)
             ratio(i+5) = circ_dispers_diam_ymm8r4(l1,l2,a5,O,inf)
             a6         = alpha(i+6)
             ratio(i+6) = circ_dispers_diam_ymm8r4(l1,l2,a6,O,inf)
             a7         = alpha(i+7)
             ratio(i+7) = circ_dispers_diam_ymm8r4(l1,l2,a7,O,inf)
             a8         = alpha(i+8)
             ratio(i+8) = circ_dispers_diam_ymm8r4(l1,l2,a8,O,inf)
             a9         = alpha(i+9)
             ratio(i+9) = circ_dispers_diam_ymm8r4(l1,l2,a9,O,inf)
             a10        = alpha(i+10)
             ratio(i+10)= circ_dispers_diam_ymm8r4(l1,l2,a10,O,inf)
             a11        = alpha(i+11)
             ratio(i+1) = circ_dispers_diam_ymm8r4(l1,l2,a11,O,inf)
             a12        = alpha(i+12)
             ratio(i+12)= circ_dispers_diam_ymm8r4(l1,l2,a12,O,inf) 
             a13        = alpha(i+13)
             ratio(i+13)= circ_dispers_diam_ymm8r4(l1,l2,a13,O,inf)
             a14        = alpha(i+14)
             ratio(i+14)= circ_dispers_diam_ymm8r4(l1,l2,a14,O,inf)
             a15        = alpha(i+15)
             ratio(i+15)= circ_dispers_diam_ymm8r4(l1,l2,a15,O,inf)
         end do

      end subroutine circ_dispers_diam_unroll_16x_ymm8r4


      subroutine circ_dispers_diam_unroll_16x_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_16x_omp_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_16x_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_16x_omp_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_unroll_16x_omp_ymm8r4

     
   
    subroutine circ_dispers_diam_unroll_8x_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_8x_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_8x_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_8x_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
      ...
      end subroutine circ_dispers_diam_unroll_8x_ymm8r4


      subroutine circ_dispers_diam_unroll_8x_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_8x_omp_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_8x_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_8x_omp_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_unroll_8x_omp_ymm8r4



     subroutine circ_dispers_diam_unroll_4x_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_4x_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_4x_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_4x_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
      ...
      end subroutine circ_dispers_diam_unroll_4x_ymm8r4


      subroutine circ_dispers_diam_unroll_4x_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_4x_omp_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_4x_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_4x_omp_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_unroll_4x_omp_ymm8r4



     subroutine circ_dispers_diam_unroll_2x_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_2x_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_2x_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_2x_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
      ...
      end subroutine circ_dispers_diam_unroll_2x_ymm8r4


      subroutine circ_dispers_diam_unroll_2x_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_2x_omp_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_2x_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_2x_omp_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_unroll_2x_omp_ymm8r4



     subroutine circ_dispers_diam_rolled_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_rolled_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_rolled_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_rolled_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
      ...
      end subroutine circ_dispers_diam_rolled_ymm8r4


      subroutine circ_dispers_diam_rolled_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_rolled_omp_ymm8r4
           !dir$ attributes forceinline :: circ_dispers_diam_rolled_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_rolled_omp_ymm8r4
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_rolled_omp_ymm8r4


     subroutine circ_dispers_diam_dispatch_ymm8r4(l1,l2,alpha,O,inf,ratio,n,unroll_cnt,omp_ver) 
          !dir$ optimize:3
          !dir$ attributes code_align : 32 :: circ_dispers_diam_dispatch_ymm8r4 
         type(YMM8r4_t),                     intent(in) :: l1
         type(YMM8r4_t),                     intent(in) :: l2
         type(YMM8r4_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM8r4_t),                     intent(in) :: O
         ...
         if(omp_ver) then
            select case (unroll_cnt)
                case (16)
                   call circ_dispers_diam_unroll_16x_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case (8)
                   call circ_dispers_diam_unroll_8x_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case (4)
                   call circ_dispers_diam_unroll_4x_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case (2)
                   call circ_dispers_diam_unroll_2x_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case (0)
                   call circ_dispers_diam_rolled_omp_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case default
                   return
             end select
          else
             select case (unroll_cnt)
                case (16)
                   call circ_dispers_diam_unroll_16x_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case (8)
                   call circ_dispers_diam_unroll_8x_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case (4)
                   call circ_dispers_diam_unroll_4x_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case (2)
                   call circ_dispers_diam_unroll_2x_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case (0)
                   call circ_dispers_diam_rolled_ymm8r4(l1,l2,alpha,O,inf,ratio,n)
                case default
                   return
             end select
     end subroutine  circ_dispers_diam_dispatch_ymm8r4 
     ...
     subroutine circ_dispers_diam_unroll_16x_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_16x_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_16x_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_16x_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
         logical(kind=i4),                    intent(in) :: inf
         type(YMM4r8_t),    dimension(1:n),  intent(out):: ratio
         integer(kind=i4),                    intent(in) :: n
         type(YMM4r8_t), automatic :: a0,a1,a2,a3,a4,a5,a6,a7
         type(YMM4r8_t), automatic :: a8,a9,a10,a11,a12,a13,a14,a15
         !dir$ attributes align : 32 :: a0,a1,a2,a3,a4,a5,a6,a7
         ...
         if(m /= 0) then
            do i=1,m
               a0   = alpha(i)
               ratio(i) = circ_dispers_diam_ymm4r8(l1,l2,a0,O,inf)
            end do
            if(n<16) return
         end if
         m1 = m+1
         ...
         do i=m1,n,16
             ...
             ratio(i)   = circ_dispers_diam_ymm4r8(l1,l2,a0,O,inf)
             a1         = alpha(i+1)
             ratio(i+1) = circ_dispers_diam_ymm4r8(l1,l2,a1,O,inf)
             a2         = alpha(i+2)
             ratio(i+2) = circ_dispers_diam_ymm4r8(l1,l2,a2,O,inf)
             a3         = alpha(i+3)
             ratio(i+3) = circ_dispers_diam_ymm4r8(l1,l2,a3,O,inf)
             a4         = alpha(i+4)
             ratio(i+4) = circ_dispers_diam_ymm4r8(l1,l2,a4,O,inf)
             a5         = alpha(i+5)
             ratio(i+5) = circ_dispers_diam_ymm4r8(l1,l2,a5,O,inf)
             a6         = alpha(i+6)
             ratio(i+6) = circ_dispers_diam_ymm4r8(l1,l2,a6,O,inf)
             a7         = alpha(i+7)
             ratio(i+7) = circ_dispers_diam_ymm4r8(l1,l2,a7,O,inf)
             a8         = alpha(i+8)
             ratio(i+8) = circ_dispers_diam_ymm4r8(l1,l2,a8,O,inf)
             a9         = alpha(i+9)
             ratio(i+9) = circ_dispers_diam_ymm4r8(l1,l2,a9,O,inf)
             a10        = alpha(i+10)
             ratio(i+10)= circ_dispers_diam_ymm4r8(l1,l2,a10,O,inf)
             a11        = alpha(i+11)
             ratio(i+1) = circ_dispers_diam_ymm4r8(l1,l2,a11,O,inf)
             a12        = alpha(i+12)
             ratio(i+12)= circ_dispers_diam_ymm4r8(l1,l2,a12,O,inf) 
             a13        = alpha(i+13)
             ratio(i+13)= circ_dispers_diam_ymm4r8(l1,l2,a13,O,inf)
             a14        = alpha(i+14)
             ratio(i+14)= circ_dispers_diam_ymm4r8(l1,l2,a14,O,inf)
             a15        = alpha(i+15)
             ratio(i+15)= circ_dispers_diam_ymm4r8(l1,l2,a15,O,inf)
         end do

      end subroutine circ_dispers_diam_unroll_16x_ymm4r8


      subroutine circ_dispers_diam_unroll_16x_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_16x_omp_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_16x_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_16x_omp_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_unroll_16x_omp_ymm4r8

     
   
    subroutine circ_dispers_diam_unroll_8x_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_8x_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_8x_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_8x_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
      ...
      end subroutine circ_dispers_diam_unroll_8x_ymm4r8


      subroutine circ_dispers_diam_unroll_8x_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_8x_omp_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_8x_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_8x_omp_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_unroll_8x_omp_ymm4r8



     subroutine circ_dispers_diam_unroll_4x_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_4x_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_4x_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_4x_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
      ...
      end subroutine circ_dispers_diam_unroll_4x_ymm4r8


      subroutine circ_dispers_diam_unroll_4x_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_4x_omp_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_4x_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_4x_omp_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_unroll_4x_omp_ymm4r8



     subroutine circ_dispers_diam_unroll_2x_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_2x_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_2x_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_2x_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
      ...
      end subroutine circ_dispers_diam_unroll_2x_ymm4r8


      subroutine circ_dispers_diam_unroll_2x_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_unroll_2x_omp_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_unroll_2x_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_unroll_2x_omp_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_unroll_2x_omp_ymm4r8



     subroutine circ_dispers_diam_rolled_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_rolled_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_rolled_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_rolled_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
      ...
      end subroutine circ_dispers_diam_rolled_ymm4r8


      subroutine circ_dispers_diam_rolled_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: circ_dispers_diam_rolled_omp_ymm4r8
           !dir$ attributes forceinline :: circ_dispers_diam_rolled_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: circ_dispers_diam_rolled_omp_ymm4r8
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
         ...
         !$omp end parallel do
     end subroutine circ_dispers_diam_rolled_omp_ymm4r8


     subroutine circ_dispers_diam_dispatch_ymm4r8(l1,l2,alpha,O,inf,ratio,n,unroll_cnt,omp_ver) 
          !dir$ optimize:3
          !dir$ attributes code_align : 32 :: circ_dispers_diam_dispatch_ymm4r8 
         type(YMM4r8_t),                     intent(in) :: l1
         type(YMM4r8_t),                     intent(in) :: l2
         type(YMM4r8_t),    dimension(1:n),  intent(in) :: alpha
         type(YMM4r8_t),                     intent(in) :: O
         ...
         if(omp_ver) then
            select case (unroll_cnt)
                case (16)
                   call circ_dispers_diam_unroll_16x_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case (8)
                   call circ_dispers_diam_unroll_8x_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case (4)
                   call circ_dispers_diam_unroll_4x_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case (2)
                   call circ_dispers_diam_unroll_2x_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case (0)
                   call circ_dispers_diam_rolled_omp_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case default
                   return
             end select
          else
             select case (unroll_cnt)
                case (16)
                   call circ_dispers_diam_unroll_16x_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case (8)
                   call circ_dispers_diam_unroll_8x_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case (4)
                   call circ_dispers_diam_unroll_4x_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case (2)
                   call circ_dispers_diam_unroll_2x_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case (0)
                   call circ_dispers_diam_rolled_ymm4r8(l1,l2,alpha,O,inf,ratio,n)
                case default
                   return
             end select
     end subroutine  circ_dispers_diam_dispatch_ymm4r8 
    ...
    subroutine fov_x_axis_unroll_16x_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_16x_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_unroll_16x_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_16x_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
         integer(kind=i4),                 intent(in)  :: n
         ...
         if(m /= 0) then
            do i=1,m
               d0    = delta(i)
               g0    = gamma(i)
               ax(i) = fov_x_axis_ymm8r4(H,d0,g0)
            end do
            if(n<16) return
         end if
         m1 = m+1
         ...
         do i=m1,n,16
            ...
            d1      = delta(i+1)
            g1      = gamma(i+1)
            ax(i+1) = fov_x_axis_ymm8r4(H,d1,g1)
            d2      = delta(i+2)
            g2      = gamma(i+2)
            ax(i+2) = fov_x_axis_ymm8r4(H,d2,g2)
            d3      = delta(i+3)
            g3      = gamma(i+3)
            ax(i+3) = fov_x_axis_ymm8r4(H,d3,g3)
            d4      = delta(i+4)
            g4      = gamma(i+4)
            ax(i+4) = fov_x_axis_ymm8r4(H,d4,g4)
            d5      = delta(i+5)
            g5      = gamma(i+5)
            ax(i+5) = fov_x_axis_ymm8r4(H,d5,g5)
            d6      = delta(i+6)
            g6      = gamma(i+6)
            ax(i+6) = fov_x_axis_ymm8r4(H,d6,g6)
            d7      = delta(i+7)
            g7      = gamma(i+7)
            ax(i+7) = fov_x_axis_ymm8r4(H,d7,g7)
            d8      = delta(i+8)
            g8      = gamma(i+8)
            ax(i+8) = fov_x_axis_ymm8r4(H,d8,g8)
            d9      = delta(i+9)
            g9      = gamma(i+9)
            ax(i+9) = fov_x_axis_ymm8r4(H,d9,g9)
            d10     = delta(i+10)
            g10     = gamma(i+10)
            ax(i+10)= fov_x_axis_ymm8r4(H,d10,g10)
            d11     = delta(i+11)
            g11     = gamma(i+11)
            ax(i+11)= fov_x_axis_ymm8r4(H,d11,g11)
            d12     = delta(i+12)
            g12     = gamma(i+12)
            ax(i+12)= fov_x_axis_ymm8r4(H,d12,g12)
            d13     = delta(i+13)
            g13     = gamma(i+13)
            ax(i+13)= fov_x_axis_ymm8r4(H,d13,g13)
            d14     = delta(i+14)
            g14     = gamma(i+14)
            ax(i+14)= fov_x_axis_ymm8r4(H,d14,g14)
            d15     = delta(i+15)
            g15     = gamma(i+15)
            ax(i+15)= fov_x_axis_ymm8r4(H,d15,g15)
         end do
     end subroutine fov_x_axis_unroll_16x_ymm8r4


     subroutine fov_x_axis_unroll_16x_omp_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_16x_omp_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_unroll_16x_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_16x_omp_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_unroll_16x_omp_ymm8r4


     subroutine fov_x_axis_unroll_8x_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_8x_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_unroll_8x_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_8x_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
     ...
     end subroutine fov_x_axis_unroll_8x_ymm8r4


     subroutine fov_x_axis_unroll_8x_omp_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_8x_omp_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_unroll_8x_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_8x_omp_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_unroll_8x_omp_ymm8r4


     subroutine fov_x_axis_unroll_4x_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_4x_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_unroll_4x_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_4x_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
     ...
     end subroutine fov_x_axis_unroll_4x_ymm8r4


     subroutine fov_x_axis_unroll_4x_omp_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_4x_omp_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_unroll_4x_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_4x_omp_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_unroll_4x_omp_ymm8r4


    subroutine fov_x_axis_unroll_2x_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_2x_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_unroll_2x_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_2x_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
     ...
     end subroutine fov_x_axis_unroll_2x_ymm8r4


     subroutine fov_x_axis_unroll_2x_omp_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_2x_omp_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_unroll_2x_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_2x_omp_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_unroll_2x_omp_ymm8r4

     

     subroutine fov_x_axis_rolled_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_rolled_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_rolled_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_rolled_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
     ...
     end subroutine fov_x_axis_rolled_ymm8r4


     subroutine fov_x_axis_rolled_omp_ymm8r4(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_rolled_omp_ymm8r4
           !dir$ attributes forceinline :: fov_x_axis_rolled_omp_ymm8r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_rolled_omp_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_rolled_omp_ymm8r4


     subroutine fov_x_axis_dispatch_ymm8r4(H,delta,gamma,ax,n,unroll_cnt,omp_ver)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_dispatch_ymm8r4
         type(YMM8r4_t),                  intent(in) :: H
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: delta
         type(YMM8r4_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM8r4_t),  dimension(1:n), intent(out) :: ax
         ...
         if(omp_ver) then
            select case (unroll_cnt)
                 case (16)
                     call fov_x_axis_unroll_16x_omp_ymm8r4(H,delta,gamma,ax,n)
                 case (8)
                     call fov_x_axis_unroll_8x_omp_ymm8r4(H,delta,gamma,ax,n)
                 case (4)
                     call fov_x_axis_unroll_4x_omp_ymm8r4(H,delta,gamma,ax,n)
                 case (2)
                     call fov_x_axis_unroll_2x_omp_ymm8r4(H,delta,gamma,ax,n)
                 case (0)
                     call fov_x_axis_rolled_omp_ymm8r4(H,delta,gamma,ax,n)
                 case default
                      return
             end select
         else
              select case (unroll_cnt)
                 case (16)
                     call fov_x_axis_unroll_16x_ymm8r4(H,delta,gamma,ax,n)
                 case (8)
                     call fov_x_axis_unroll_8x_ymm8r4(H,delta,gamma,ax,n)
                 case (4)
                     call fov_x_axis_unroll_4x_ymm8r4(H,delta,gamma,ax,n)
                 case (2)
                     call fov_x_axis_unroll_2x_ymm8r4(H,delta,gamma,ax,n)
                 case (0)
                     call fov_x_axis_rolled_ymm8r4(H,delta,gamma,ax,n)
                 case default
                      return
             end select
         end if
     end subroutine fov_x_axis_dispatch_ymm8r4
     ...
     pure function fov_x_axis_ymm4r8(H,delta,gamma) result(ax)
      ...
      subroutine fov_x_axis_unroll_16x_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_16x_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_unroll_16x_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_16x_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         integer(kind=i4),                 intent(in)  :: n
         type(YMM4r8_t), automatic :: d0,d1,d2,d3,d4,d5,d6,d7
         type(YMM4r8_t), automatic :: d8,d9,d10,d11,d12,d13,d14,d15
         !dir$ attributes align : 32 :: d0,d1,d2,d3,d4,d5,d6,d7
         !dir$ attributes align : 32 :: d8,d9,d10,d11,d12,d13,d14,d15
         type(YMM4r8_t), automatic :: g0,g1,g2,g3,g4,g,g6,g7
         type(YMM4r8_t), automatic :: g8,g9,g10,g11,g12,g13,g14,g15
         ...
         if(m /= 0) then
            do i=1,m
               d0    = delta(i)
               g0    = gamma(i)
               ax(i) = fov_x_axis_ymm4r8(H,d0,g0)
            end do
            if(n<16) return
         end if
         m1 = m+1
         ...
         do i=m1,n,16
            ...
            d1      = delta(i+1)
            g1      = gamma(i+1)
            ax(i+1) = fov_x_axis_ymm4r8(H,d1,g1)
            d2      = delta(i+2)
            g2      = gamma(i+2)
            ax(i+2) = fov_x_axis_ymm4r8(H,d2,g2)
            d3      = delta(i+3)
            g3      = gamma(i+3)
            ax(i+3) = fov_x_axis_ymm4r8(H,d3,g3)
            d4      = delta(i+4)
            g4      = gamma(i+4)
            ax(i+4) = fov_x_axis_ymm4r8(H,d4,g4)
            d5      = delta(i+5)
            g5      = gamma(i+5)
            ax(i+5) = fov_x_axis_ymm4r8(H,d5,g5)
            d6      = delta(i+6)
            g6      = gamma(i+6)
            ax(i+6) = fov_x_axis_ymm4r8(H,d6,g6)
            d7      = delta(i+7)
            g7      = gamma(i+7)
            ax(i+7) = fov_x_axis_ymm4r8(H,d7,g7)
            d8      = delta(i+8)
            g8      = gamma(i+8)
            ax(i+8) = fov_x_axis_ymm4r8(H,d8,g8)
            d9      = delta(i+9)
            g9      = gamma(i+9)
            ax(i+9) = fov_x_axis_ymm4r8(H,d9,g9)
            d10     = delta(i+10)
            g10     = gamma(i+10)
            ax(i+10)= fov_x_axis_ymm4r8(H,d10,g10)
            d11     = delta(i+11)
            g11     = gamma(i+11)
            ax(i+11)= fov_x_axis_ymm4r8(H,d11,g11)
            d12     = delta(i+12)
            g12     = gamma(i+12)
            ax(i+12)= fov_x_axis_ymm4r8(H,d12,g12)
            d13     = delta(i+13)
            g13     = gamma(i+13)
            ax(i+13)= fov_x_axis_ymm4r8(H,d13,g13)
            d14     = delta(i+14)
            g14     = gamma(i+14)
            ax(i+14)= fov_x_axis_ymm4r8(H,d14,g14)
            d15     = delta(i+15)
            g15     = gamma(i+15)
            ax(i+15)= fov_x_axis_ymm4r8(H,d15,g15)
         end do
     end subroutine fov_x_axis_unroll_16x_ymm4r8


     subroutine fov_x_axis_unroll_16x_omp_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_16x_omp_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_unroll_16x_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_16x_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_unroll_16x_omp_ymm4r8


     subroutine fov_x_axis_unroll_8x_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_8x_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_unroll_8x_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_8x_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
     ...
     end subroutine fov_x_axis_unroll_8x_ymm4r8


     subroutine fov_x_axis_unroll_8x_omp_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_8x_omp_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_unroll_8x_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_8x_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_unroll_8x_omp_ymm4r8


     subroutine fov_x_axis_unroll_4x_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_4x_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_unroll_4x_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_4x_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         integer(kind=i4),                 intent(in)  :: n
         type(YMM4r8_t), automatic :: d0,d1,d2,d3
         !dir$ attributes align : 32 :: d0,d1,d2,d3
         type(YMM4r8_t), automatic :: g0,g1,g2,g3
         !dir$ attributes align : 32 :: g0,g1,g2,g3
         integer(kind=i4) :: i,m,m1
     ...
     end subroutine fov_x_axis_unroll_4x_ymm4r8


     subroutine fov_x_axis_unroll_4x_omp_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_4x_omp_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_unroll_4x_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_4x_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_unroll_4x_omp_ymm4r8


    subroutine fov_x_axis_unroll_2x_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_2x_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_unroll_2x_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_2x_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         integer(kind=i4),                 intent(in)  :: n
         type(YMM4r8_t), automatic :: d0,d1
         !dir$ attributes align : 32 :: d0,d1
         type(YMM4r8_t), automatic :: g0,g1
         !dir$ attributes align : 32 :: g0,g1
         integer(kind=i4) :: i,m,m1
     ...
     end subroutine fov_x_axis_unroll_2x_ymm4r8


     subroutine fov_x_axis_unroll_2x_omp_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_unroll_2x_omp_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_unroll_2x_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_unroll_2x_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_unroll_2x_omp_ymm4r8

     

     subroutine fov_x_axis_rolled_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_rolled_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_rolled_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_rolled_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         integer(kind=i4),                 intent(in)  :: n
         type(YMM4r8_t), automatic :: d0
         !dir$ attributes align : 32 :: d0
         type(YMM4r8_t), automatic :: g0
         !dir$ attributes align : 32 :: g0
         integer(kind=i4) :: i
     ...
     end subroutine fov_x_axis_rolled_ymm4r8


     subroutine fov_x_axis_rolled_omp_ymm4r8(H,delta,gamma,ax,n)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_rolled_omp_ymm4r8
           !dir$ attributes forceinline :: fov_x_axis_rolled_omp_ymm4r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: fov_x_axis_rolled_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         ...
         !$omp end parallel do
     end subroutine fov_x_axis_rolled_omp_ymm4r8


     subroutine fov_x_axis_dispatch_ymm4r8(H,delta,gamma,ax,n,unroll_cnt,omp_ver)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 :: fov_x_axis_dispatch_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: gamma
         type(YMM4r8_t),  dimension(1:n), intent(out) :: ax
         ...
         if(omp_ver) then
            select case (unroll_cnt)
                 case (16)
                     call fov_x_axis_unroll_16x_omp_ymm4r8(H,delta,gamma,ax,n)
                 case (8)
                     call fov_x_axis_unroll_8x_omp_ymm4r8(H,delta,gamma,ax,n)
                 case (4)
                     call fov_x_axis_unroll_4x_omp_ymm4r8(H,delta,gamma,ax,n)
                 case (2)
                     call fov_x_axis_unroll_2x_omp_ymm4r8(H,delta,gamma,ax,n)
                 case (0)
                     call fov_x_axis_rolled_omp_ymm4r8(H,delta,gamma,ax,n)
                 case default
                      return
             end select
         else
              select case (unroll_cnt)
                 case (16)
                     call fov_x_axis_unroll_16x_ymm4r8(H,delta,gamma,ax,n)
                 case (8)
                     call fov_x_axis_unroll_8x_ymm4r8(H,delta,gamma,ax,n)
                 case (4)
                     call fov_x_axis_unroll_4x_ymm4r8(H,delta,gamma,ax,n)
                 case (2)
                     call fov_x_axis_unroll_2x_ymm4r8(H,delta,gamma,ax,n)
                 case (0)
                     call fov_x_axis_rolled_ymm4r8(H,delta,gamma,ax,n)
                 case default
                      return
             end select
         end if
     end subroutine fov_x_axis_dispatch_ymm4r8
     ...
     subroutine scan_width_unroll_16x_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_unroll_16x_ymm4r8
         !dir$ attributes forceinline :: scan_width_unroll_16x_ymm4r8
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_unroll_16x_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
         integer(kind=i4),                 intent(in)  :: n
         type(YMM4r8_t), automatic :: d0,d1,d2,d3,d4,d5,d6,d7
         type(YMM4r8_t), automatic :: d8,d9,d10,d11,d12,d13,d14,d15
         !dir$ attributes align : 32 :: d0,d1,d2,d3,d4,d5,d6,d7
         ...
         do i=m1,n,16
            ...
            d1      = delta(i+1)
            g1      = theta(i+1)
            B(i+1) = scan_width_ymm4r8(H,d1,g1)
            d2      = delta(i+2)
            g2      = theta(i+2)
            B(i+2) = scan_width_ymm4r8(H,d2,g2)
            d3      = delta(i+3)
            g3      = theta(i+3)
            B(i+3) = scan_width_ymm4r8(H,d3,g3)
            d4      = delta(i+4)
            g4      = theta(i+4)
            B(i+4) = scan_width_ymm4r8(H,d4,g4)
            d5      = delta(i+5)
            g5      = theta(i+5)
            B(i+5) = scan_width_ymmm4r8(H,d5,g5)
            d6      = delta(i+6)
            g6      = theta(i+6)
            B(i+6) = scan_width_ymm4r8(H,d6,g6)
            d7      = delta(i+7)
            g7      = theta(i+7)
            B(i+7) = scan_width_ymm4r8(H,d7,g7)
            d8      = delta(i+8)
            g8      = theta(i+8)
            B(i+8) = scan_width_ymm4r8(H,d8,g8)
            d9      = delta(i+9)
            g9      = theta(i+9)
            B(i+9) = scan_width_ymm4r8(H,d9,g9)
            d10     = delta(i+10)
            g10     = theta(i+10)
            B(i+10)= scan_width_ymm4r8(H,d10,g10)
            d11     = delta(i+11)
            g11     = theta(i+11)
            B(i+11)= scan_width_ymm4r8(H,d11,g11)
            d12     = delta(i+12)
            g12     = theta(i+12)
            B(i+12)= scan_width_ymm4r8(H,d12,g12)
            d13     = delta(i+13)
            g13     = theta(i+13)
            B(i+13)= scan_width_ymm4r8(H,d13,g13)
            d14     = delta(i+14)
            g14     = theta(i+14)
            B(i+14)= scan_width_ymm4r8(H,d14,g14)
            d15     = delta(i+15)
            g15     = theta(i+15)
            B(i+15)= scan_width_ymm4r8(H,d15,g15)
         end do
      end subroutine scan_width_unroll_16x_ymm4r8


      subroutine scan_width_unroll_16x_omp_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_unroll_16x_omp_ymm4r8
         !dir$ attributes forceinline :: scan_width_unroll_16x_omp_ymm4r8
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_unroll_16x_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
         ...
         !$omp end parallel do
      end subroutine scan_width_unroll_16x_omp_ymm4r8


      subroutine scan_width_unroll_8x_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_unroll_8x_ymm4r8
         !dir$ attributes forceinline :: scan_width_unroll_8x_ymm4r8
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_unroll_8x_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
      ...
      end subroutine scan_width_unroll_8x_ymm4r8


      subroutine scan_width_unroll_8x_omp_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_unroll_8x_omp_ymm4r8
         !dir$ attributes forceinline :: scan_width_unroll_8x_omp_ymm4r8
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_unroll_8x_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
         ...
         do i=m1,n,8
            ...
            d5      = delta(i+5)
            g5      = theta(i+5)
            B(i+5) = scan_width_ymm4r8(H,d5,g5)
            d6      = delta(i+6)
            g6      = theta(i+6)
            B(i+6) = scan_width_ymm4r8(H,d6,g6)
            d7      = delta(i+7)
         ...
         !$omp end parallel do
      end subroutine scan_width_unroll_8x_omp_ymm4r8


      subroutine scan_width_unroll_4x_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_unroll_4x_ymm4r8
         !dir$ attributes forceinline :: scan_width_unroll_4x_ymm4r8
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_unroll_4x_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
      ...
      end subroutine scan_width_unroll_4x_ymm4r8


      subroutine scan_width_unroll_4x_omp_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_unroll_4x_omp_ymm4r8
         !dir$ attributes forceinline :: scan_width_unroll_4x_omp_ymm4r8
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_unroll_4x_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
         ...
         !$omp end parallel do
     end subroutine scan_width_unroll_4x_omp_ymm4r8



     subroutine scan_width_unroll_2x_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_unroll_2x_ymm4r8
         !dir$ attributes forceinline :: scan_width_unroll_2x_ymm4r8
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_unroll_2x_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
      ...
      end subroutine scan_width_unroll_2x_ymm4r8


      subroutine scan_width_unroll_2x_omp_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_unroll_2x_omp_ymm4r8
         !dir$ attributes forceinline :: scan_width_unroll_2x_omp_ymm4r8
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_unroll_2x_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
         ...
         !$omp end parallel do
     end subroutine scan_width_unroll_2x_omp_ymm4r8


     subroutine scan_width_rolled_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_rolled_ymm8r4
         !dir$ attributes forceinline :: scan_width_rolled_ymm8r4
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_rolled_ymm8r4
      ...
      end subroutine scan_width_rolled_ymm4r8


      subroutine scan_width_rolled_omp_ymm4r8(H,delta,theta,B,n)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_rolled_omp_ymm4r8
         !dir$ attributes forceinline :: scan_width_rolled_omp_ymm4r8
         !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: scan_width_rolled_omp_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
         ...
         !$omp end parallel do
     end subroutine scan_width_rolled_omp_ymm4r8


     subroutine scan_width_dispatch_ymm4r8(H,delta,theta,B,n,unroll_cnt,omp_ver)
         !dir$ optimize:3
         !dir$ attributes code_align : 32 :: scan_width_dispatch_ymm4r8
         type(YMM4r8_t),                  intent(in) :: H
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: delta
         type(YMM4r8_t),  dimension(1:n), intent(in)  :: theta
         type(YMM4r8_t),  dimension(1:n), intent(out) :: B
         ...
         if(omp_ver) then
            select case (unroll_cnt)
                case (16)
                   call scan_width_unroll_16x_omp_ymm4r8(H,delta,theta,B,n)
                case (8)
                   call scan_width_unroll_8x_omp_ymm4r8(H,delta,theta,B,n)
                case (4)
                   call scan_width_unroll_4x_omp_ymm4r8(H,delta,theta,B,n)
                case (2)
                   call scan_width_unroll_2x_omp_ymm4r8(H,delta,theta,B,n)
                case (0)
                   call scan_width_rolled_omp_ymm4r8(H,delta,theta,B,n)
                case default
                   return
             end select
          else
              select case (unroll_cnt)
                case (16)
                   call scan_width_unroll_16x_ymm4r8(H,delta,theta,B,n)
                case (8)
                   call scan_width_unroll_8x_ymm4r8(H,delta,theta,B,n)
                case (4)
                   call scan_width_unroll_4x_ymm4r8(H,delta,theta,B,n)
                case (2)
                   call scan_width_unroll_2x_ymm4r8(H,delta,theta,B,n)
                case (0)
                   call scan_width_rolled_ymm4r8(H,delta,theta,B,n)
                case default
                   return
             end select
     end subroutine scan_width_dispatch_ymm4r8
     ...
     pure function refract_shift_ymm8r4(i1,delta,alfa,gamma,n)  result(l)
       ...
       subroutine refract_shift_unroll_16x_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_unroll_16x_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_unroll_16x_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_unroll_16x_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
            type(YMM8r4_t), dimension(1:len),   intent(in) :: n
            type(YMM8r4_t), dimension(1:len),   intent(out):: l
            ...
            !dir$ attributes align : 32 :: g0,g1,g2,g3,g4,g5,g6,g7
            !dir$ attributes align : 32 :: g8,g9,g10,g11,g12,g13,g14,g15
            type(YMM8r4_t), automatic :: n0,n1,n2,n3,n4,n5,n6,n7
            type(YMM8r4_t), automatic :: n8,n9,n10,n11,n12,n13,n14,n15
            ...
            do i=1,m
               ...
               g0     = gamma(i)
               n0     = n(i)
               l(i)   = refract_shift_ymm8r4(i1,delta,a0,g0,n0)
            end do
            if(len<16) return
            end if
           m1 = m+1
           ...
           do i=m1,len,16
             ...
             g1     = gamma(i+1)
             n1     = n(i+1)
             l(i+1) = refract_shift_ymm8r4(i1,delta,a1,g1,n1)
             a2     = alfa(i+2)
             g2     = gamma(i+2)
             n2     = n(i+2)
             l(i+2) = refract_shift_ymm8r4(i1,delta,a2,g2,n2)
             a3     = alfa(i+3)
             g3     = gamma(i+3)
             n3     = n(i+3)
             l(i+3) = refract_shift_ymm8r4(i1,delta,a3,g3,n3)
             a4     = alfa(i+4)
             g4     = gamma(i+4)
             n4     = n(i+4)
             l(i+4) = refract_shift_ymm8r4(i1,delta,a4,g4,n4)
             a5     = alfa(i+5)
             g5     = gamma(i+5)
             n5     = n(i+5)
             l(i+5) = refract_shift_ymm8r4(i1,delta,a5,g5,n5)
             a6     = alfa(i+6)
             g6     = gamma(i+6)
             n6     = n(i+6)
             l(i+6) = refract_shift_ymm8r4(i1,delta,a6,g6,n6)
             a7     = alfa(i+7)
             g7     = gamma(i+7)
             n7     = n(i+7)
             l(i+7) = refract_shift_ymm8r4(i1,delta,a7,g7,n7)
             a8     = alfa(i+8)
             g8     = gamma(i+8)
             n8     = n(i+8)
             l(i+8) = refract_shift_ymm8r4(i1,delta,a8,g8,n8)
             a9     = alfa(i+9)
             g9     = gamma(i+9)
             n9     = n(i+9)
             l(i+9) = refract_shift_ymm8r4(i1,delta,a9,g9,n9)
             a10    = alfa(i+10)
             g10    = gamma(i+10)
             n10    = n(i+10)
             l(i+10)= refract_shift_ymm8r4(i1,delta,a10,g10,n10)
             a11    = alfa(i+11)
             g11    = gamma(i+11)
             n11    = n(i+11)
             l(i+11)= refract_shift_ymm8r4(i1,delta,a11,g11,n11)
             a12    = alfa(i+12)
             g12    = gamma(i+12)
             n12    = n(i+12)
             l(i+12)= refract_shift_ymm8r4(i1,delta,a12,g12,n12)
             a13    = alfa(i+13)
             g13    = gamma(i+13)
             n13    = n(i+13)
             l(i+13)= refract_shift_ymm8r4(i1,delta,a13,g13,n13)
             a14    = alfa(i+14)
             g14    = gamma(i+14)
             n14    = n(i+14)
             l(i+14)= refract_shift_ymm8r4(i1,delta,a14,g14,n14)
             a15    = alfa(i+15)
             g15    = gamma(i+15)
             n15    = n(i+15)
             l(i+15)= refract_shift_ymm8r4(i1,delta,a15,g15,n15)
         end do
      end subroutine refract_shift_unroll_16x_ymm8r4


      subroutine refract_shift_unroll_16x_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_unroll_16x_omp_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_unroll_16x_omp_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_unroll_16x_omp_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
          ...
          !$omp end parallel do
      end subroutine refract_shift_unroll_16x_omp_ymm8r4


      subroutine refract_shift_unroll_8x_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_unroll_8x_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_unroll_8x_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_unroll_8x_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
      ...
      end subroutine refract_shift_unroll_8x_ymm8r4


      subroutine refract_shift_unroll_8x_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_unroll_8x_omp_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_unroll_8x_omp_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_unroll_8x_omp_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
          ...
          !$omp end parallel do
      end subroutine refract_shift_unroll_8x_omp_ymm8r4


      subroutine refract_shift_unroll_4x_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_unroll_4x_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_unroll_4x_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_unroll_4x_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
            ...
            type(YMM8r4_t) , automatic :: g0,g1,g2,g3
            !dir$ attributes align : 32 :: g0,g1,g2,g3
            type(YMM8r4_t), automatic :: n0,n1,n2,n3
      ...
      end subroutine refract_shift_unroll_4x_ymm8r4


      subroutine refract_shift_unroll_4x_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_unroll_4x_omp_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_unroll_4x_omp_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_unroll_4x_omp_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
          ...
          !$omp end parallel do
      end subroutine refract_shift_unroll_4x_omp_ymm8r4


      subroutine refract_shift_unroll_2x_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_unroll_2x_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_unroll_2x_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_unroll_2x_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
      ...
      end subroutine refract_shift_unroll_2x_ymm8r4


      subroutine refract_shift_unroll_2x_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_unroll_2x_omp_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_unroll_2x_omp_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_unroll_2x_omp_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
          ...
          !$omp end parallel do
      end subroutine refract_shift_unroll_2x_omp_ymm8r4


      subroutine refract_shift_rolled_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_rolled_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_rolled_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_rolled_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
      ...
      end subroutine refract_shift_rolled_ymm8r4


      subroutine refract_shift_rolled_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
            !dir$ optimize:3
            !dir$ attributes code_align : 32 ::  refract_shift_rolled_omp_ymm8r4
            !dir$ attributes forceinline ::  refract_shift_rolled_omp_ymm8r4
            !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" :: refract_shift_rolled_omp_ymm8r4
            type(YMM8r4_t),                     intent(in) :: i1
            type(YMM8r4_t),                     intent(in) :: delta
            type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
            type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
          ...
          !$omp end parallel do
      end subroutine refract_shift_rolled_omp_ymm8r4

      
      subroutine refract_shift_dispatch_ymm8r4(i1,delta,alfa,gamma,n,l,len,unroll_cnt,omp_ver)
          !dir$ optimize:3
          !dir$ attributes code_align : 32 :: refract_shift_dispatch_ymm8r4
          type(YMM8r4_t),                     intent(in) :: i1
          type(YMM8r4_t),                     intent(in) :: delta
          type(YMM8r4_t), dimension(1:len),   intent(in) :: alfa
          type(YMM8r4_t), dimension(1:len),   intent(in) :: gamma
          ...
          if(omp_ver) then
             select case (unroll_cnt)
                 case (16)
                    call refract_shift_unroll_16x_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case (8)
                    call refract_shift_unroll_8x_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case (4)
                    call refract_shift_unroll_4x_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case (2)
                    call refract_shift_unroll_2x_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case (0)
                    call refract_shift_rolled_omp_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case default
                    return
             end select
          else
              select case (unroll_cnt)
                 case (16)
                    call refract_shift_unroll_16x_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case (8)
                    call refract_shift_unroll_8x_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case (4)
                    call refract_shift_unroll_4x_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case (2)
                    call refract_shift_unroll_2x_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case (0)
                    call refract_shift_rolled_ymm8r4(i1,delta,alfa,gamma,n,l,len)
                 case default
                    return
             end select
          end if
      end subroutine refract_shift_dispatch_ymm8r4
