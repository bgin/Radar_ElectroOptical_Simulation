...
!$omp end parallel do
       ...
       subroutine cos_series_unroll8x_r4(om0,n,coss,k)
           ...
           !dir$ attributes forceinline ::  cos_series_unroll8x_r4
       ...
       subroutine cos_series_unroll8x_r8(om0,n,coss,k)
           ...
           !dir$ attributes forceinline ::  cos_series_unroll8x_r8
       ...
       !==========================================================================================
         ...
         subroutine sin_series_unroll8x_r4(om0,n,sins,k)
           ...
           !dir$ attributes forceinline ::  sin_series_unroll8x_r4
       ...
       subroutine sin_series_unroll8x_r8(om0,n,sins,k)
           ...
           !dir$ attributes forceinline ::  sin_series_unroll8x_r8
       ...
       subroutine radiation_flux_spectrum(Phi_in,Phi_out,dim_len,data_len,status)
        ...
        subroutine squared_cos_flux_unroll8x_r4(Phi0t,Phi0,n,tin)
           ...
           !dir$ attributes forceinline ::   squared_cos_flux_unroll8x_r4
        ...
        subroutine squared_cos_flux_unroll8x_r8(Phi0t,Phi0,n,tin)
           ...
           !dir$ attributes forceinline ::   squared_cos_flux_unroll8x_r8
        ...
        subroutine const_flux_spectr_unroll8x_r4(Phi0f,Phi0,freq,n,T)
           ...
           !dir$ attributes forceinline ::   const_flux_spectr_unroll8x_r4
       ...
       subroutine const_flux_spectr_unroll8x_r8(Phi0f,Phi0,freq,n,T)
           ...
           !dir$ attributes forceinline ::   const_flux_spectr_unroll8x_r8
        ...
        !Formula 1,2 p. 187
        subroutine ideal_modulator_unroll8x_r4(rhot_s,rhot_c,n,f0,phi0,rho0,rho1)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 ::  ideal_modulator_unroll8x_r4
           !dir$ attributes forceinline ::   ideal_modulator_unroll8x_r4
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" ::  ideal_modulator_unroll8x_r4
           ...
           real(kind=sp), parameter :: twopi = 6.283185307179586476925286766559_dp
           real(kind=sp) :: t0,t1,t2,t3,t4,t5,t6,t7
        ...
        end subroutine ideal_modulator_unroll8x_r4
        

       subroutine ideal_modulator_unroll8x_r8(rhot_s,rhot_c,n,f0,phi0,rho0,rho1)
           !dir$ optimize:3
           !dir$ attributes code_align : 32 ::  ideal_modulator_unroll8x_r8
           !dir$ attributes forceinline ::   ideal_modulator_unroll8x_r8
           !dir$ attributes optimization_parameter:"target_arch=skylake-avx512" ::  ideal_modulator_unroll8x_r8
