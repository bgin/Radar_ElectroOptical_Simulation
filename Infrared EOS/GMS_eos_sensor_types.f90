...
!==================================================================================85
   ...
   public
     ...
     ! Module build date
     character(*),        parameter :: EOS_SENSOR_TYPES_BUILD_DATE  = __DATE__ 
     
     character(*),        parameter :: EIS_SENSOR_TYPES_BUILD_TIME  = __TIME__
     ! Module author info
...
#if !defined (EOS_SENSOR_TYPES_PAD_STRUCTS)
#define EOS_SENSOR_TYPES_PAD_STRUCTS 1
#endif 
...
#if (EOS_SENSOR_TYPES_PAD_STRUCTS) == 1
           STRUCT_PADDING(0,28)
#endif
     ...
     type, public :: sin_series_r8_t
           ...
           STRUCT_PADDING(0,12)
#endif             
           real(kind=dp), dimension(:),   allocatable :: sines
           !dir$ attributes align : 64 :: sines
     end type sin_series_r8_t
       ...
       type, public :: raster_transmit_phit_r4_t
        ...
        type, public :: raster_transmit_phit_r8_t
         ...
         type, public :: raster_transmitt_t_r4_t
             ...
             real(kind=sp),  dimension(:),allocatable   :: rhod_d
             !dir$ attributes align : 64 :: rhod_d 
         ...
         type, public :: raster_transmitt_t_r8_t
           ...
           STRUCT_PADDING(0,16)
             ...
             real(kind=dp),  dimension(:),allocatable   :: rhod_d
             !dir$ attributes align : 64 :: rhod_d 
         ...
         type, public :: eo_sensor_r4_t
               ...
               type(traj_scan_dydt_r4_t)          :: m_traj_scan_dydt
           ...
           type, public :: eo_sensor_r8_t
               ...
               type(traj_scan_dydt_r8_t)          :: m_traj_scan_dydt
