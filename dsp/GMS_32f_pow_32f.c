...
#define DSP_32F_POW_32F_BLOCK                                                  \
	...
	const int32_t len = npoints/8;
          ...
          void
          pow_u_ymm8r4_ymm8r4_looped(float * __restrict c,
...
#pragma loop_count min(1),avg(4),max(8)
	  ...
	  void
          pow_a_ymm8r4_ymm8r4_looped(float * __restrict __attribute__((aligned(32))) c,
                                     float * __restrict __attribute__((aligned(32))) b,
...
#pragma loop_count min(1),avg(4),max(8)
	  ...
	  __m256
          pow_ymm8r4_ymm8r4(const __m256 x,
                            const __m256 y) {
