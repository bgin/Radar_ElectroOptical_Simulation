...
#include "GMS_scalv_avx512_unrolled8x.h"
	  ...
	  void
          sscalv_a_zmm16r4_unroll8x(const int32_t n,
                                    const float alpha,
...
#pragma code_align(32)
	  ...
	  void
          sscalv_a_zmm16r4_unroll8x_omp(const int32_t n,
                                        const float alpha,
			                float * __restrict __ATTR_ALIGN__(64) x,
			                const int32_t incx) {
                       if(__builtin_expect(0==n,0) ||
...
#pragma omp parallel for schedule(static,128) default(none) private(i)  \
          ...
          void
          dscalv_u_zmm8r8_unroll8x( const int32_t n,
                                    const double alpha,
			            double * __restrict x,
			            const int32_t incx) {
	  ...
	  void
          dscalv_a_zmm8r8_unroll8x( const int32_t n,
                                    const double alpha,
...
#pragma code_align(32)
	  ...
	  void
          dscalv_a_zmm8r8_unroll8x_omp( const int32_t n,
                                        const double alpha,
			                double * __restrict __ATTR_ALIGN__(64) x,
			                const int32_t incx) {
