...
!DIR$ ATTRIBUTES INLINE :: DGEMM_Haswell_AVX2
      implicit none
      CHARACTER*1        TRANSA, TRANSB
      INTEGER            M, N, K, LDA, LDB, LDC, INFO
      INTEGER            MB, NB, NBT, KB 
...
SUBROUTINE DGEMM_SKX_AVX512(TRANSA,TRANSB,M,N,K,ALPHA,A,LDA,B,LDB,&
                          BETA,C,LDC,INFO,MB,NB,NBT, KB) 
!     *     .. Scalar Arguments ..
...
BETA,C,LDC,RCB,MB,NB,NBT,KB) !GCC$ ATTRIBUTES aligned(32) :: DSYMM !GCC$ ATTRIBUTES hot :: DSYMM !GCC$ ATTRIBUTES no_stack_protector :: DSYMM !GCC$ ATTRIBUTES no_profile_instrument_function :: DSYMM
      use omp_lib
      implicit none
